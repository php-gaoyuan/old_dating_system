<?php
	...
	if($dbo->exeUpdate($sql)){
		...
		$title=$b_langpackage->b_write_ask_re."<a href=\"home2.0.php?h=".$ask_title['user_id']."&app=ask_show&id=".$ask_id."\" target='_blank'>(".$ask_title['user_name'].$b_langpackage->b_write_ask_qu.")".$title."</a>";
