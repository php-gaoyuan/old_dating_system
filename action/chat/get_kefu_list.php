...
foreach($service_list as $slist){
	$con.="<div class='kefu_lists'>
			<a class='kefu_img' href='modules2.0.php?app=u_chat_info'><img src='$slist[user_ico]' /></a>
			<div class='kefu_jianjie' title='$slist[content]'>$slist[user_name][在线]:\"$slist[content]\"</div>
			<a class='btn_zixun' href='modules2.0.php?app=u_chat_info'>".$pu_langpackage->zixun_chat."</a>
		</div>";
 }
