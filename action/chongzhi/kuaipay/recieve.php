	...
	if ($ok == 1) { 
		switch($_REQUEST[payResult]){
				case '10':
						...
						$rtnUrl="http://www.partyings.com/do.php?act=kshow&msg=$msg";
						break;
				default:
						$rtnOK=1;
						//���������ǿ�Ǯ���õ�showҳ�棬�̻���Ҫ�Լ������ҳ�档
						$rtnUrl="http://www.partyings.com/do.php?act=kshow&msg=false";
						break;	
						...
						$rtnOK=1;
						//���������ǿ�Ǯ���õ�showҳ�棬�̻���Ҫ�Լ������ҳ�档
						$rtnUrl="http://www.partyings.com/do.php?act=kshow&msg=error";
