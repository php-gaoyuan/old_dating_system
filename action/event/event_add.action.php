...
if($dbo->exeUpdate($sql)){
	...
	$dbo->exeUpdate($sql);
	if($public!=2){
		$title="发起了活动<a href='home2.0.php?h=".$user_id."&app=event_space&event_id=".$event_id."' target='_blank'>".$title."</a>";
		$content="<img class='photo_frame' src='".$poster_thumb."' />";
		$is_suc=api_proxy("message_set",0,$title,$content,0,11);
	}
	action_return(1,"","modules2.0.php?app=event_space&event_id=$event_id");
}else{
