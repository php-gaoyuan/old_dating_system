...
//定义写操作
  ...
  $dbo->exeUpdate($sql);
	...
	$scrip_content=$ea_langpackage->ea_you_invited_out.'<a href="home2.0.php?h='.$user_id.'&app=event_space&event_id='.$event_id.'" target="_blank">'.$event_name.'</a>'.$ea_langpackage->ea_activity;
