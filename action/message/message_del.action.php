...
echo "<li id='remind_".$rs['id']."'>
				<div class='photo'><a href='home2.0.php?h=".$rs['from_uid']."' target='_blank'><img src='".$rs['from_uico']."' width='20px' height='20px' alt='' target='_blank' /></a></div>
					<div class='remind_content'>
						<a href='home2.0.php?h=".$rs['from_uid']."' target='_blank'>".$rs['from_uname']."</a>";
