<?php
	...
	if(!$user_info){
		action_return($result_type,$mb_langpackage->mb_add_err,"modules2.0.php?app=msgboard_more&user_id=$to_user_id");exit;
	}	
	...
	if($dbo -> exeUpdate($sql)){
		if($to_user_id!=$from_user_id){
			...
			api_proxy("message_set",$to_user_id,$mb_langpackage->mb_remind,"modules2.0.php?app=msgboard_more",0,7,"remind");
		}
		if($restore==1){
