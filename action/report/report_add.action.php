<?php
	...
	if($report_row){
		...
		switch($type){
			...
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$user_id.'" target="_blank">'.$blog_row['user_name'].'</a>'.$rp_langpackage->rp_blog.'<a href="../home2.0.php?h='.$userd_id.'&app=blog&id='.$blog_row['log_id'].'" target="_blank">{ico_url}</a>';
			...
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$userd_id.'" target="_blank">'.$groups_row['group_creat_name'].'</a>'.$rp_langpackage->rp_group.'<a href="../home2.0.php?h='.$userd_id.'&app=group_space&group_id='.$groups_row['group_id'].'" target="_blank">{ico_url}</a>';
			...
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$userd_id.'" target="_blank">'.$album_row['user_name'].'</a>'.$rp_langpackage->rp_alb.'<a href="../home2.0.php?h='.$userd_id.'&app=photo_list&album_id='.$album_row['album_id'].'" target="_blank">'.$album_row['album_name'].'<br /><img src="../{ico_url}" width="100" /></a>';
			...
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$userd_id.'" target="_blank">'.$userd_name.'</a>'.$rp_langpackage->rp_pho.'<a href="../home2.0.php?h='.$userd_id.'&app=photo&album_id='.$photo_row['album_id'].'&photo_id='.$photo_row['photo_id'].'" target="_blank">'.$photo_row['photo_name'].'<br /><img src="../{ico_url}" width="100" /></a>';
			$content=str_replace('{ico_url}',$photo_row['photo_src'],$content);
			break;
			case 4:
			$poll_row=api_proxy("poll_self_by_pollid","*",$mod_id);
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$userd_id.'" target="_blank">'.$poll_row['username'].'</a>'.$rp_langpackage->rp_poll.'<a href="../home2.0.php?h='.$userd_id.'&app=poll&p_id='.$poll_row['p_id'].'" target="_blank">{ico_url}</a>';
			$content=str_replace('{ico_url}',$poll_row['subject'],$content);
			break;
			case 8:
			$share_row=api_proxy("share_self_by_sid","*",$mod_id);
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$userd_id.'" target="_blank">'.$share_row['user_name'].'</a>'.$rp_langpackage->rp_share.'<br />{ico_url}';
			$search=array('href="');
			$replace=array('href="../');
			...
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$userd_id.'" target="_blank">'.$subject_row['user_name'].'</a>'.$rp_langpackage->rp_sub.'<a href="../home2.0.php?h='.$userd_id.'&app=group_sub_show&subject_id='.$subject_row['subject_id'].'&group_id='.$subject_row['group_id'].'" target="_blank">{ico_url}</a>';
			$content=str_replace('{ico_url}',$subject_row['title'],$content);
			break;
			case 10:
			$user_row=api_proxy("user_self_by_uid","user_id,user_name",$mod_id);
			$content=$rp_langpackage->rp_report.'<a href="../home2.0.php?h='.$userd_id.'" target="_blank">{ico_url}</a>'.$rp_langpackage->rp_space;
