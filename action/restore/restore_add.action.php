...
if($host_id!=$visitor_id){
	...
	if($last_id){
		...
		echo '
				<a class="figure" href="home2.0.php?h='.$visitor_id.'" target="_blank"><img src="'.$visitor_ico.'"/></a>
				<a href="home2.0.php?h='.$visitor_id.'" target="_blank">'.filt_word($visitor_name).'</a><label>'.date("Y-m-d H:i:s",time()).'</label>
