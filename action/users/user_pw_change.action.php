<?php
	...
	if($new_pw != $new_pw_repeat){
		action_return(0,$u_langpackage->u_pw2_err,"modules2.0.php?app=user_pw_change");exit;
	}
	if(!$user_id){
	...
	if($user_row['user_pws']==$formerly_pw){
		...
		$dbo->exeUpdate($sql);
		action_return(1,$u_langpackage->u_pw_chg_suc,"modules2.0.php?app=user_pw_change");
	}else{
		action_return(0,$u_langpackage->u_pw_err,"modules2.0.php?app=user_pw_change");
	}
}
?>