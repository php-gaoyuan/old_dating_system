...
//加分过程
	...
	//纪录新鲜事
	$title=$pol_langpackage->pol_participate_vote.'<a href="home2.0.php?h='.$user_id.'&app=poll&p_id='.$pid.'" target="_blank">'.$p_subject.'</a>';
	$content='<a href="home2.0.php?h='.$user_id.'&app=poll&p_id='.$pid.'" target="_blank">'.$p_subject.'</a>';
