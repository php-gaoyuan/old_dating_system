  ...
  $dbo=new dbex;
	...
	switch($s_type){
		...
		if($rs['user_id']==$user_id){
			...
			$user_name='<a href="home2.0.php?h='.$rs['user_id'].'" target="_blank">'.$rs['user_name'].'</a>';
			$title_data=$title_data ? $title_data:$rs['log_title'];
			$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_s_log.'<a href="home2.0.php?h='.$rs['user_id'].'&app=blog&id='.$s_content_id.'" target="_blank">'.$title_data.'</a>';
		...
		if($rs['add_userid']==$user_id){
			...
			$user_name='<a href="home2.0.php?h='.$rs['add_userid'].'" target="_blank">'.$rs['group_creat_name'].'</a>';
			$title_data=$title_data ? $title_data:$rs['group_name'];
			$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_s_group.'<a href="home2.0.php?h='.$rs['add_userid'].'&app=group_space&group_id='.$s_content_id.'" target="_blank">'.$title_data.'</a>';
			$share_id=share_act($dbo,$s_type,$s_content_id,$title,$tag);
		...
		if($rs['user_id']==$user_id){
			...
			$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_s_album.'<a href="home2.0.php?h='.$rs['user_id'].'&app=photo_list&album_id='.$s_content_id.'" target="_blank">'.$title_data.'</a>';
			$share_id=share_act($dbo,$s_type,$s_content_id,$title,$tag);
			$content='<a href="home2.0.php?h='.$rs['user_id'].'&app=photo_list&album_id='.$s_content_id.'" target="_blank"><img class="photo_frame" onerror=parent.pic_error(this) src="'.$rs['album_skin'].'" /></a>';
		}
		break;
		...
		if($rs['user_id']==$user_id){
			...
			$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_s_photos.'<a href="home2.0.php?h='.$rs['user_id'].'&app=photo&photo_id='.$s_content_id.'&album_id='.$rs['album_id'].'" target="_blank">'.$title_data.'</a>';
			$share_id=share_act($dbo,$s_type,$s_content_id,$title,$tag);
			$content='<a href="home2.0.php?h='.$rs['user_id'].'&app=photo&photo_id='.$s_content_id.'&album_id='.$rs['album_id'].'" target="_blank"><img class="photo_frame" onerror=parent.pic_error(this) src="'.$rs['photo_thumb_src'].'"/></a>';
		}
		break;
		...
		if($rs['user_id']==$user_id){
			...
			$user_name='<a href="home2.0.php?h='.$rs['user_id'].'" target="_blank">'.$rs['username'].'</a>';
			$title_data=$title_data ? $title_data:$rs['subject'];
			$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_s_vote.'<a href="home2.0.php?h='.$rs['user_id'].'&app=poll&p_id='.$s_content_id.'" target="_blank">'.$rs['subject'].'</a>';
			$share_id=share_act($dbo,$s_type,$s_content_id,$title,$tag);
		...
		case "6":
			...
			$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_music.'<a href="home2.0.php?h='.$uid.'&app=share_show&s_id='.$s_content_id.'" target="_blank">'.$title_data.'</a>';
			$share_id=share_act($dbo,$s_type,$s_content_id,$title,$tag,$re_link);
			$content='<div class="music_player"><a href="home2.0.php?h='.$user_id.'&app=share_show&s_id='.$share_id.'" target="_blank"></a></div>';
		break;
		...
		if($s_content_id){
			...
			$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_video.'<a href="home2.0.php?h='.$uid.'&app=share_show&s_id='.$s_content_id.'" target="_blank">'.$title_data.'</a>';
			$share_id=share_act($dbo,$s_type,$s_content_id,$title,$tag,$re_link,$re_thumb,$re_m_link);
			$content='<div style="background:url('.$re_thumb.') no-repeat scroll 0% 0% transparent;" class="movie_player"><a href="home2.0.php?h='.$user_id.'&app=share_show&s_id='.$share_id.'" target="_blank"></a></div>';
		break;
		...
		case "8":
			...
			if($rs['user_id']==$user_id){
				...
				$title=$s_langpackage->s_shared.$user_name.$s_langpackage->s_s_topic.'<a href="home2.0.php?h='.$rs['user_id'].'&app=group_sub_show&group_id='.$rs['group_id'].'&subject_id='.$s_content_id.'" target="_blank">'.$title_data.'</a>';
				$share_id=share_act($dbo,$s_type,$s_content_id,$title,$tag);
