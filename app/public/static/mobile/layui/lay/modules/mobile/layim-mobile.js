...
layui.define(['laytpl', 'upload-mobile', 'layer-mobile', 'zepto'], function (exports) {
    ...
    //接受消息
    LAYIM.prototype.getMessage = function (data, msgType) {
        return getMessage(data, msgType), this;
    };
    ...
    var popPanel = function (options, anim) {
        ...
        return layer.open({
            ...
            , shadeClose: false
            , anim: -1
            , content: laytpl(comTpl(options.tpl, anim === -1 ? false : true, false)).render(data)
            , success: function (elem) {
                var othis = $(elem);
    ...
    //接受消息
    var messageNew = {}, getMessage = function (data, msgType) {
        data = data || {};
