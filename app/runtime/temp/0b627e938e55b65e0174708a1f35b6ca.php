<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/www.dsrramtcys.com/app/application/index/view/mall/index.html";i:1609051846;}*/ ?>
<!DOCTYPE html>
...
<body>
	...
	<header class="mui-bar mui-bar-nav">
	    ...
	    <a class="mui-pull-right" style="line-height:44px;font-size:14px;display: none;" href="<?php echo url('greetcard/index'); ?>"><?php echo lang("greet card"); ?></a>
	...
	<div class="mui-content">
		...
		<div class="mui-slider">
		    ...
		    <div class="mui-slider-indicator mui-segmented-control mui-segmented-control-inverted" style="display: none;">
