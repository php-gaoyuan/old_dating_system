<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/www.dsrramtcys.com/app/application/index/view/album/add.html";i:1609051846;}*/ ?>
<!doctype html>
<html>

	<head>
		<meta charset="UTF-8">
		<title><?php echo lang("create_album"); ?></title>
	...
	<body>
		...
		<header class="mui-bar mui-bar-nav">
		    ...
		    <h1 class="mui-title"><?php echo lang("create_album"); ?></h1>
		</header>
		<?php endif; ?>
		<div class="mui-content">
			<form class="mui-input-group">
			    <div class="mui-input-row">
			        ...
			        <input type="text" name="album_name" id="album_name" class="mui-input-clear" placeholder="">
			    </div>

			    <div class="mui-input-row" style="height:80px;">
			        <label><?php echo lang('album_desc'); ?></label>
			        <textarea class="mui-textarea" name="album_info" id="album_info"></textarea>
			    </div>
			    <!-- <div class="mui-input-row">
			        <label>隐私设置</label>
			    </div>
		...
		<script type="text/javascript">
			...
			layui.use(["jquery","layer"],function(){
				...
				$("#sub").click(function(){
					...
					$.post("<?php echo url('album/add'); ?>",{album_name:album_name,album_info:album_info},function(res){
