<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/www.dsrramtcys.com/app/application/index/view/set/index.html";i:1609063263;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
	<meta charset="UTF-8" />
	...
	<div class="mui-content">
		<ul class="mui-table-view">
		    ...
		    <ul class="mui-table-view">
		        ...
		        <li class="mui-table-view-cell">
		            <a class="mui-navigate-right" href="<?php echo url('article/index',['item'=>'about']); ?>">
		                 <?php echo lang('about us'); ?>
		            </a>
		        </li>
		        <li class="mui-table-view-cell">
		            <a class="mui-navigate-right" href="<?php echo url('article/index',['item'=>'terms']); ?>">
		                 <?php echo lang('tiaokuan'); ?>
		            </a>
		        </li>
		        <li class="mui-table-view-cell">
		            <a class="mui-navigate-right" href="<?php echo url('article/index',['item'=>'privacy']); ?>">
		                 <?php echo lang('privacy'); ?>
		            </a>
		        </li>
		        
		        <li class="mui-table-view-cell">
		            <a class="mui-navigate-right" href="<?php echo url('article/index',['item'=>'safe']); ?>">
		                 <?php echo lang('jysafe'); ?>
		            </a>
		        </li>
		        <li class="mui-table-view-cell">
		            <a class="mui-navigate-right" href="<?php echo url('article/index',['item'=>'help']); ?>">
		                <?php echo lang('help center'); ?>
		            </a>
		        </li>
		        <li class="mui-table-view-cell">
		            <a class="mui-navigate-right" href="<?php echo url('article/index',['item'=>'contact']); ?>">
	...
	$(function(){
		...
		$("#logout").click(function(){
			$.get("<?php echo url('index/logout'); ?>",{},function(res){
				mui.toast(res);
				window.location.href="https://m.dsrramtcys.com/";
			});
		});
	});
	</script>
