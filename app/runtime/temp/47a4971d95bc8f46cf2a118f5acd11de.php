<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/jyo.henangaodu.com/app/application/index/view/upgrade/index.html";i:1603376728;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
				...
				<ul class="mui-table-view">
			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    ...
			        	    <input name="vip" type="radio" value="12">
			        	</div>
		                <div class="mui-pull-left li-center" >USD12</div>
		                <div class="mui-pull-right li-right">USD12/<?php echo lang('month'); ?></div>
			        </li>

			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>3<?php echo lang('month2'); ?></label>
			        	    <input name="vip" type="radio" value="30" checked>
			        	</div>
		                <div class="mui-pull-left li-center" >USD30</div>
		                <div class="mui-pull-right li-right">USD30/<?php echo lang('month'); ?></div>
			        </li>

			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>6<?php echo lang('month2'); ?></label>
			        	    <input name="vip" type="radio" value="59">
			        	</div>
		                <div class="mui-pull-left li-center" >USD59</div>
		                <div class="mui-pull-right li-right">USD59/<?php echo lang('month'); ?></div>
			        </li>

			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>12<?php echo lang('month2'); ?></label>
			        	    <input name="vip" type="radio" value="108" >
			        	</div>
		                <div class="mui-pull-left li-center" >USD108</div>
		                <div class="mui-pull-right li-right">USD108/<?php echo lang('month'); ?></div>
			        </li>
			    </ul>
			</div>
				...
				<ul class="mui-table-view">
			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    ...
			        	    <input name="vip" type="radio" value="100">
			        	</div>
		                <div class="mui-pull-left li-center" >USD100</div>
		                <div class="mui-pull-right li-right">USD100/<?php echo lang('yongjiu'); ?></div>
			        </li>
					<li class="mui-table-view-cell">
						<div class="mui-input-row mui-radio mui-left mui-pull-left">
							<label><?php echo lang('yongjiu'); ?></label>
							<input name="vip" type="radio" value="288">
						</div>
						<div class="mui-pull-left li-center" >USD288</div>
						<div class="mui-pull-right li-right">USD288/<?php echo lang('yongjiu'); ?></div>
					</li>
					<li class="mui-table-view-cell">
						<div class="mui-input-row mui-radio mui-left mui-pull-left">
							<label><?php echo lang('yongjiu'); ?></label>
							<input name="vip" type="radio" value="521">
						</div>
						<div class="mui-pull-left li-center" >USD521</div>
						<div class="mui-pull-right li-right">USD521/<?php echo lang('yongjiu'); ?></div>
					</li>
					<li class="mui-table-view-cell">
						<div class="mui-input-row mui-radio mui-left mui-pull-left">
							<label><?php echo lang('yongjiu'); ?></label>
							<input name="vip" type="radio" value="999">
						</div>
						<div class="mui-pull-left li-center" >USD999</div>
						<div class="mui-pull-right li-right">USD999/<?php echo lang('yongjiu'); ?></div>
					</li>
