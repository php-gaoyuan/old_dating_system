<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/www.partyings.com/app/application/index/view/recharge/index.html";i:1562825235;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="mui-content">
    <form action="<?php echo url('recharge/create_pay'); ?>" method="post" onsubmit="checkForm();">
            ...
            <div class="mui-card-content">
                <div class="mui-row" id="pay_list">
                    <div class="mui-col-sm-6 mui-col-xs-6">
                        <img src="<?php echo config('skin_path'); ?>/images/fuHui.png" alt="cropay" class="pay_type active" id="pay_fuhui">
                    </div>
                    <div class="mui-col-sm-6 mui-col-xs-6">
                        <img src="<?php echo config('skin_path'); ?>/images/papy.jpg" alt="paypal" class="pay_type" id="pay_paypal">
                    </div>
        ...
        <!--cropay弹窗s-->
        <div class="" id="fht_cont" style="display:;">
            <div class="input-row"><label for="" style="width:100%;">單筆交易金額最大不能超過1000USD</label></div>
            <div class="input-row">
                <label><?php echo lang('fht_card'); ?></label>
                <input type="text" class="mui-input-clear" name="card_number" id="card_number" placeholder="<?php echo lang('fht_card_desc'); ?>">
            </div>
            <div class="input-row"><label><?php echo lang('fht_yxq'); ?></label><select name="exp_year"
                                                                              id="exp_year"></select><select
                    name="exp_month" id="exp_month"></select></div>
            <div class="input-row"><label><?php echo lang('fht_cvv'); ?></label><input type="text" class="mui-input-clear"
                                                                             name="cvv" id="cvv"
                                                                             placeholder="<?php echo lang('fht_cvv_desc'); ?>">
            </div>
            <div class="input-row"><label><?php echo lang('fht_name'); ?></label><input type="text" class="mui-input-clear"
                                                                              name="name" id="name"
                                                                              value="<?php echo $pay_userinfo['name']; ?>"></div>
            <div class="input-row"><label><?php echo lang('fht_country'); ?></label><select name="country" id="country"
                                                                                  style="width:65%;">
                ...
                <option value="MO">澳门(MO)</option>
                <option value="DE">德國(DE)</option>
                <option value="GB">英國(GB)</option>
                <option value="CA">加拿大(CA)</option>
                <option value="TH">泰國(TH)</option>
                <option value="ID">印度尼西亞(ID)</option>
                <option value="AU">澳大利亞(AU)</option>
            </select></div>
            <div class="input-row"><label><?php echo lang('fht_province'); ?></label><input type="text" class="mui-input-clear"
                                                                                  name="province" id="province"
                                                                                  value="<?php echo $pay_userinfo['province']; ?>">
            </div>
            <div class="input-row"><label><?php echo lang('fht_city'); ?></label><input type="text" class="mui-input-clear"
                                                                              name="city" id="city"
                                                                              value="<?php echo $pay_userinfo['city']; ?>"></div>
            <div class="input-row"><label><?php echo lang('fht_address'); ?></label><input type="text" class="mui-input-clear"
                                                                                 name="address" id="address"
                                                                                 value="<?php echo $pay_userinfo['address']; ?>">
            </div>
            <div class="input-row"><label><?php echo lang('fht_email'); ?></label><input type="text" class="mui-input-clear"
                                                                               name="email" id="email"
                                                                               value="<?php echo $pay_userinfo['email']; ?>"></div>
            <div class="input-row"><label><?php echo lang('fht_telephone'); ?></label><input type="text" class="mui-input-clear"
                                                                                   name="telephone" id="telephone"
                                                                                   value="<?php echo $pay_userinfo['telephone']; ?>">
            </div>
            <div class="input-row"><label><?php echo lang('fht_post'); ?></label><input type="text" class="mui-input-clear"
                                                                              name="post" id="post"
                                                                              value="<?php echo $pay_userinfo['post']; ?>"></div>
        </div>
        <!--cropay弹窗e-->
