<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/jyo.henangaodu.com/app/application/index/view/chat/chat.html";i:1602502927;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
		...
		layui.use(["mobile", "jquery", 'layer'], function() {
			...
			layim.on('tool(video)', function(insert, send, obj){
		  		...
		  		pclayer.open({
			    	...
			    	skin : 'video-class',
			    	closeBtn:false,
			    	content:"<?php echo url('Index/video'); ?>"
			  	});
