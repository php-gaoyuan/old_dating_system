<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/www.partyings.com/app/application/index/view/set/about.html";i:1603037127;}*/ ?>
<!doctype html>
<html>
		...
		<div class="mui-content">
			...
			<ul class="mui-table-view">
			    ...
			    <div class="center bottom">
			    	<?php echo lang('guanwang'); ?>：jyo.henangaodu.com <br />
			    </div>
		</div>
