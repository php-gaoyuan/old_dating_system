<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/www.dsrramtcys.com/app/application/index/view/upgrade/index.html";i:1609064218;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
				...
				<ul class="mui-table-view">
			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>1<?php echo lang('month2'); ?>
			        	    <input name="vip" type="radio" value="<?php echo $groupList[0]['month1']; ?>"></label>
			        	</div>
<!--		                <div class="mui-pull-left li-center" >USD20</div>-->
		                <div class="mui-pull-right li-right">USD<?php echo $groupList[0]['month1']; ?></div>
			        </li>

			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>3<?php echo lang('month2'); ?>
			        	    <input name="vip" type="radio" value="<?php echo $groupList[0]['month3']; ?>" checked></label>
			        	</div>

		                <div class="mui-pull-right li-right">USD<?php echo $groupList[0]['month3']; ?></div>
			        </li>

			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>6<?php echo lang('month2'); ?>
			        	    <input name="vip" type="radio" value="<?php echo $groupList[0]['month6']; ?>"></label>
			        	</div>

		                <div class="mui-pull-right li-right">USD<?php echo $groupList[0]['month6']; ?></div>
			        </li>

			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>12<?php echo lang('month2'); ?>
			        	    <input name="vip" type="radio" value="<?php echo $groupList[0]['month12']; ?>" ></label>
			        	</div>

		                <div class="mui-pull-right li-right">USD<?php echo $groupList[0]['month12']; ?></div>
			        </li>
			    </ul>
			</div>
			...
			<div class="mui-card-content">
				<ul class="mui-table-view">
			        <li class="mui-table-view-cell">
			        	<div class="mui-input-row mui-radio mui-left mui-pull-left">
			        	    <label>1<?php echo lang('month2'); ?>
			        	    <input name="vip" type="radio" value="<?php echo $groupList[1]['month1']; ?>"></label>
			        	</div>

		                <div class="mui-pull-right li-right">USD<?php echo $groupList[1]['month1']; ?></div>
			        </li>
					<li class="mui-table-view-cell">
						<div class="mui-input-row mui-radio mui-left mui-pull-left">
							<label>3<?php echo lang('month2'); ?>
							<input name="vip" type="radio" value="<?php echo $groupList[1]['month3']; ?>"></label>
						</div>

						<div class="mui-pull-right li-right">USD<?php echo $groupList[1]['month3']; ?></div>
					</li>
					<li class="mui-table-view-cell">
						<div class="mui-input-row mui-radio mui-left mui-pull-left">
							<label>6<?php echo lang('month2'); ?>
							<input name="vip" type="radio" value="<?php echo $groupList[1]['month6']; ?>"></label>
						</div>

						<div class="mui-pull-right li-right">USD<?php echo $groupList[1]['month6']; ?></div>
					</li>
					<li class="mui-table-view-cell">
						<div class="mui-input-row mui-radio mui-left mui-pull-left">
							<label>12<?php echo lang('month2'); ?>
							<input name="vip" type="radio" value="<?php echo $groupList[1]['month12']; ?>"></label>
						</div>
						
						<div class="mui-pull-right li-right">USD<?php echo $groupList[1]['month12']; ?></div>
					</li>
