<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/www.pauzzz.com/app/application/index/view/profile/index.html";i:1562814526;}*/ ?>
<!doctype html>
<html>
	...
	<body>
			...
			<div class="mui-slider">
			    ...
			    <div class="mui-slider-group">
			        ...
			        <div id="item1" class="mui-slider-item mui-control-content mui-active">
			            ...
			            <form class="mui-input-group" target="pauzzz" method="post" action="<?php echo url('profile/index'); ?>">
		...
		<iframe  name="pauzzz" id="pauzzz" src="" frameborder="0" style="display:none"></iframe>
