<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/www.partyings.com/app/application/index/view/profile/mood.html";i:1562814526;}*/ ?>
<!doctype html>
<html>
				...
				var options = {
					...
					isAuto:true,
						...
						$.getJSON("/index/home/mood/uid/<?php echo $userinfo['user_id']; ?>/page/"+page,{},function(res){
							...
							$(".photo_frame").attr("src","http://www.partyings.com/"+$(".photo_frame").attr("src"));
						});
					}
				};
