<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/jyo.henangaodu.com/app/application/index/view/profile/index.html";i:1602502927;}*/ ?>
<!doctype html>
<html>
	...
	<body>
			...
			<div class="mui-slider">
			    ...
			    <div class="mui-slider-group">
			        ...
			        <div id="item1" class="mui-slider-item mui-control-content mui-active">
			            ...
			            <form class="mui-input-group" target="partyings" method="post" action="<?php echo url('profile/index'); ?>">
		...
		<iframe  name="partyings" id="partyings" src="" frameborder="0" style="display:none"></iframe>
