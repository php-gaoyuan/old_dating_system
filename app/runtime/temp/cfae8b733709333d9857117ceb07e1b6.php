<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/www.dsrramtcys.com/app/application/index/view/photo/index.html";i:1609051846;}*/ ?>
<!doctype html>
<html>
		...
		<div class="mui-content" style="padding:54px 0 10px;">
			...
			<div class="mui-row" style="margin:10px 0;padding:10px 10px 10px;background:#fff;" id="list">
				...
				<div class="mui-col-xs-4 img_div" >
					<img src="http://jyo.henangaodu.com/<?php echo (isset($vo['photo_src']) && ($vo['photo_src'] !== '')?$vo['photo_src']:'uploadfiles/album/logo.jpg'); ?>" alt="">
