<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/www.pauzzz.com/app/application/index/view/photo/index.html";i:1562814526;}*/ ?>
<!doctype html>
<html>
		...
		<div class="mui-content" style="padding:54px 0 10px;">
			...
			<div class="mui-row" style="margin:10px 0;padding:10px 10px 10px;background:#fff;" id="list">
				...
				<div class="mui-col-xs-4 img_div" >
					<img src="http://www.pauzzz.com/<?php echo (isset($vo['photo_src']) && ($vo['photo_src'] !== '')?$vo['photo_src']:'uploadfiles/album/logo.jpg'); ?>" alt="">
