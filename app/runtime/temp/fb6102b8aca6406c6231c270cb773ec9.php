<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/jyo.henangaodu.com/app/application/index/view/greetcard/pay.html";i:1602502927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	...
	<div class="mui-content">
		<form class="mui-input-group" method="post" action="">
		    ...
		    <div class="form-block">
		    	...
		    	<div class="mui-row">
		    		<textarea name="note" rows="5" cols="" class="form-text"></textarea>
		    	</div>
		    </div>
		    <div class="form-block">
	...
	$(function(){
		$("#sub").click(function(){
			...
			$.post("<?php echo url('greetcard/sub_pay'); ?>",data,function(res){
				if(res.msg){
					mui.toast(res.msg);
				}
