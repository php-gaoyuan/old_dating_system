package 
{
    ...
    public class AvatarEditor extends Sprite
    {
        ...
        private function editPhoto() : void
        {
            ...
            this.smallEditWin.edit(this.editData, 100, 100);
            this.editState.addChild(this.bigEditWin);
            this.bigEditWin.edit(this.editData, 165, 165);
        ...
        private function initUI() : void
        {
            ...
            this.largeThumb = new PhotoThumb(165, 165, "你的大头像(将显示在个人主页)");
            this.smallThumb = new PhotoThumb(100, 100, "你的小头像");
            this.previewState.addChild(this.largeThumb);
            this.previewState.addChild(this.smallThumb);
            this.smallThumbButton = new ThumbButton(100, 100, "小头像预览");
            this.smallThumbButton.drawData(new BitmapData(100, 100, false, 13421772));
            this.bigThumbButton = new ThumbButton(165, 165, "大头像预览");
            this.bigThumbButton.drawData(new BitmapData(165, 165, false, 13421772));
        ...
        {
            this.smallEditWin = new EditWindow(null, 280, 280, 100, 100);
            this.smallEditWin.x = 20;
            this.smallEditWin.y = 32;
            this.bigEditWin = new EditWindow(null, 280, 280, 165, 165);
