...
$actArray = array(
    "jst_xz" => array('action/jst_xz.action.php'),
    "mood_up_acttion" => array('action/mood_up_acttion.action.php'),
    "check_name" => array('action/check_name.action.php'),
    "change_rz" => array('action/change_rz.action.php'),
    "kaishijifei" => array('action/chat/kaishijifei.php'),
    "service_chat" => array('action/chat/service_chat.php'),
    "get_kefu_list" => array('action/chat/get_kefu_list.php'),
    "login" => array('action/login_act.php'),
    "logout" => array('action/logout_act.php', "$indexFile"),
    "reg" => array('action/reg_act.php', 'main.php'),

    "group_creat" => array('action/group/group_creat.action.php', 'modules2.0.php?app=group'),
    "group_join" => array('action/group/group_join.action.php'),
    "group_del_sub" => array('action/group/group_del_subject.action.php'),
    "group_exit" => array('action/group/group_exit.action.php', 'modules2.0.php?app=group'),
    "group_drop" => array('action/group/group_drop.action.php', 'modules2.0.php?app=group'),
    ...
    "album_del" => array('action/album/album_del.action.php', 'modules2.0.php?app=album'),
    "album_upd" => array('action/album/album_upd.action.php', 'modules2.0.php?app=album'),
    ...
    "msg_crt_hf" => array('action/msgscrip/msg_crt_hf.action.php'),
    ...
    "getmsscount" => array('action/get_mess_count.action.php'),

    "set_status" => array('action/users/set_status.action.php'),
    "user_info" => array('action/users/user_info.action.php'),
    "up_user_ico" => array('action/users/up_user_ico.action.php'),
    ...
    "pals_sort_add" => array('action/mypals/pals_sort_add.action.php', 'modules2.0.php?app=mypals_sort'),
    "pals_change" => array('action/mypals/pals_change.action.php'),
    "pals_sort_change" => array('action/mypals/pals_sort_change.action.php'),
    "pals_sort_del" => array('action/mypals/pals_sort_del.action.php', 'modules2.0.php?app=mypals_sort'),
    "del_mypals" => array('action/mypals/pals_del.action.php', 'modules2.0.php?app=mypals'),
    "refuse_req" => array('action/mypals/refuse_req.action.php', 'modules2.0.php?app=mypals_request'),
    "del_req" => array('action/mypals/del_req.action.php', 'modules2.0.php?app=mypals_request'),
    "confirm_both" => array('action/mypals/confirm_both.action.php', 'modules2.0.php?app=mypals_request'),
    "confirm_other" => array('action/mypals/confirm_other.action.php', 'modules2.0.php?app=mypals_request'),

    "blog_add" => array('action/blog/blog_add.action.php', 'modules2.0.php?app=blog_list'),
    "blog_del" => array('action/blog/blog_del.action.php', 'modules2.0.php?app=blog_list'),
    "blog_edit" => array('action/blog/blog_edit.action.php'),
    "blog_sort_add" => array('action/blog/blog_sort_add.action.php'),
    "blog_sort_del" => array('action/blog/blog_sort_del.action.php', 'modules2.0.php?app=blog_manager_sort'),
    ...
    "poll_add" => array('action/poll/poll_add.action.php', 'modules2.0.php?app=poll_mine'),
    ...
    "event_add" => array('action/event/event_add.action.php', 'modules2.0.php?app=event'),
    "event_edit" => array('action/event/event_edit.action.php', 'modules2.0.php?app=event'),
    "event_join" => array('action/event/event_join.action.php', 'modules2.0.php?app=event_all'),
    "event_del_member" => array('action/event/event_del_member.action.php', 'modules2.0.php?app=event'),
    "event_appoint" => array('action/event/event_appoint.action.php', 'modules2.0.php?app=event'),
    "event_revoke" => array('action/event/event_revoke.action.php', 'modules2.0.php?app=event'),
    "event_approve" => array('action/event/event_approve.action.php', 'modules2.0.php?app=event'),
    "event_del_req" => array('action/event/event_del_req.action.php', 'modules2.0.php?app=event'),
    "event_invite" => array('action/event/event_invite.action.php', 'modules2.0.php?app=event'),
    "event_exit" => array('action/event/event_exit.action.php', 'modules2.0.php?app=event'),
    "event_drop" => array('action/event/event_drop.action.php', 'modules2.0.php?app=event'),
    "event_follow" => array('action/event/event_follow.action.php', 'modules2.0.php?app=event'),
    "event_follow_cancel" => array('action/event/event_follow_cancel.action.php', 'modules2.0.php?app=event'),
    ...
    "event_edit_apply" => array('action/event/event_edit_apply.action.php', 'modules2.0.php?app=event'),
    ...
    "pay" => array('action/chongzhi/pay.action.php'),
    "paynotify" => array('action/chongzhi/paynotify.action.php'),
    "upgrade" => array('action/chongzhi/upgrade.action.php'),
    "tenpay_url" => array('action/chongzhi/return_url.php'),
    "tenpay_show" => array('action/chongzhi/show.php'),
    "krecieve" => array('action/chongzhi/kuaipay/recieve.php'),
    "kshow" => array('action/chongzhi/kuaipay/show.php'),

    "stamps" => array('action/stamps/stamps.action.php', 'modules2.0.php?app=stamps'),

    "bott_del" => array('action/bottle/bott_del.action.php'),
    "bott_reply" => array('action/bottle/bott_reply.action.php'),
    "bott_crt" => array('action/bottle/bott_crt.action.php'),
    "bott_crt2" => array('action/bottle/bott_crt2.action.php'),
    "bott_pick" => array('action/bottle/bott_pick.action.php', 'modules2.0.php?app=bott_in'),

    "sign_add" => array('action/sign/sign_add.action.php'),

    "impression_add" => array('action/impression/impression_add.action.php'),

    "del_guest" => array('action/guest/guest_del.action.php'),
