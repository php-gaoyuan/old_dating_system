...
$actArray=array(
    ...
    "send_email"=>array('action/msgscrip/send_email.php'),
    ...
    "stamps" => array('action/stamps/stamps.action.php','modules.php?app=stamps'),
    ...
    "bott_pick"=> array('action/bottle/bott_pick.action.php','modules.php?app=bott_in'),
    ...
    'cash'=>array('action/chongzhi/cash.php')
