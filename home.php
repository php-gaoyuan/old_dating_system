...
<!-- 	  <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=user_info&user_id=<?php echo $holder_id;?>&single=1';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_data;?></a></li> -->
	  <li><a href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=blog_list&user_id=<?php echo $holder_id;?>';home_index.style.display='none';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_log;?></a></li>
	  <li><a href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=album&user_id=<?php echo $holder_id;?>';home_index.style.display='none';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_album;?></a></li>
	  <li><a href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=share_list&user_id=<?php echo $holder_id;?>';home_index.style.display='none';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_share;?></a></li>
    <li><a href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=mood_more&user_id=<?php echo $holder_id;?>';home_index.style.display='none';return false;" hidefocus="true"><?php echo $mn_langpackage->mn_mood;?></a></li>
...
<div class="wrapper" style="margin-top:0">
  ...
  <!--homeleft_start!-->
	...
	<div class="right">
	 ...
	 <div class="right_l" id='home_index'>
...
<?php if($sessuserinfo['user_group']==2 || $sessuserinfo['user_group'] == 3){ ?>
		...
		<? } else { ?>
            ...
            <div><a href='http://www.missinglovelove.com/main.php?app=user_upgrade' target='_blank'><?php echo $u_langpackage->readmore; ?></a></div>
