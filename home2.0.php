...
if(empty($user_info)){
    echo "<script>alert('Without this user（沒有此用戶）!');window.history.back();</script>";exit;
}
if ($is_self == 'N') {
...
<html>
    ...
    <head id="Head1">
        ...
        <script type='text/javascript' src="skin/default/js/jy.js">
        </script>
        <script type='text/javascript' src="servtools/imgfix.js">
        </script>
        <script type='text/javascript' src="skin/default/js/jooyea.js">
        </script>
        <script type='text/javascript' src="servtools/ajax_client/ajax.js">
        </script>
        <script type="text/javascript" language="javascript" src="servtools/dialog/zdrag.js">
        </script>
        <script type="text/javascript" language="javascript" src="servtools/dialog/zdialog.js">
        </script>
        <script type="text/javascript" language="javascript" src="servtools/calendar.js">
        </script>
        <link href="./template/her/christmas2014.css" rel="stylesheet" type="text/css">
        <script src="./template/her/jquery-1.7.min.js" type="text/javascript">
        </script>
        <script src="./template/layer/layer.js" type="text/javascript">
        </script>
        <script>
            $(function() {
                layer.photos({
        ...
        <style type='text/css'>
            #nav_lq .nav_charge_lq, #nav_lq a.nav_charge_lq:hover{line-height: 26px;padding: 0 10px;display: inline-block;background: rgb(200,0,0);border-radius: 5px;}
            #gotop{width: 28px;height: 28px;cursor: pointer;position: fixed;right: 60px;bottom: 0px;z-index: 9999;background: url(skin/default/jooyea/images/back_top.gif) no-repeat;_background: url(skin/default/jooyea/images/back_top.gif) no-repeat;top: auto;}
        </style>
    </head>
        ...
        <div id="container_lf" style=" background:url(skin/default/jooyea/images/banner.png) no-repeat  ">
            ...
            <div class="tabs_box1_lf">
                <div id="js_member_a" class="tabs_lf">
                    <a class="first_child_lf active1_tab_lf" href="<?php echo $siteDomain;?>home2.0.php?h=<?php echo $holder_id;?>">
                        <?php echo $ah_langpackage->ah_personal_homepage;?>
                    </a>
                    <a class="nav01" href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=blog_list&user_id=<?php echo $holder_id;?>';content_index_lf.style.display='none';return false;"
                    hidefocus="true">
                        <?php echo $ah_langpackage->ah_log;?>
                    </a>
                    <a class="nav02" href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=album&user_id=<?php echo $holder_id;?>';content_index_lf.style.display='none';return false;"
                    hidefocus="true">
                        <?php echo $ah_langpackage->ah_album;?>
                    </a>
                    <a class="nav03" href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=share_list&user_id=<?php echo $holder_id;?>';content_index_lf.style.display='none';return false;"
                    hidefocus="true">
                        <?php echo $ah_langpackage->ah_share;?>
                    </a>
                    <a class="nav04" href="javascript:void(0);" onclick="frame_index.style.display='block';frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=mood_more&user_id=<?php echo $holder_id;?>';content_index_lf.style.display='none';return false;"
                    hidefocus="true">
                ...
                <div id="content_box1_lf">
                    ...
                    <div id="iframe_div_lf">
                        <div class="right_l" id='frame_index' style='display:none'>
                            <iframe onload="this.height=frame_content.document.body.scrollHeight" id="frame_content" name="frame_content" scrolling="no" frameborder="0" width="100%" allowTransparency="true">
                            </iframe>
                        </div>
                        ...
                        <div id="content_index_lf" style="margin-top: 0;">
                            ...
                            <div class="top_content_lf" style="margin-top: -5px;">
                                ...
                                <ul class="photos_boxs_lf" style="margin-bottom: 20px;">
                                    <?php foreach ($all as $key=>$value) { if($key< 5){?>
                                    <li>
                                        <img layer-src="<?php echo $value[photo_src]; ?>" layer-pid layer-index="<?php echo $key; ?>"
                                        src="<?php echo $value[photo_src]; ?>" class="cursor_zoom" style="width:115px;"
                            ...
                            <div id="home_list_box1_lf" class="w730">
                                <?php if(!empty($mood)){ foreach($mood as $key=>$value){ $add_time = substr($value['add_time'], 0, 10);?>
                                    <!--循环项-->
                                    <dl class="mood">
                                        <dt>
                                            <a target="_blank" href="home2.0.php?h=<?php echo $value[user_id];?>">
                                                <img src="<?php echo $user_info[user_ico];?>" width="52" height="52" alt="<?php echo $value[user_name];?>">
                                            </a>
                                            <i class="christmas-adornments  ">
                                            </i>
                                        </dt>
                                        <dd class="share_title_sun somethingnew_tr">
                                            <a target="_blank" class="name_box1_lf" href="home2.0.php?h=<?php echo $value[user_id];?>">
                                        ...
                                        <dd class="comment_cont_lf comment_tree1_parent_lq">
                                            ...
                                            <p class="info_box1_lf">
                                                ...
                                                <?php 
                                                foreach ($mood_comment as $k=>$v) { if($value['mood_id'] == $v['mood_id']){ 
                                                    //echo "<pre>";print_r($sessuserinfo);exit; 
                                                    //男号不看男号的评论 
                                                    if($sessuserinfo["user_sex"]== 1){ 
                                                        ...
                                                        $res = $dbo->getRow($sql); 
                                                        if($res["user_sex"] == 1){ 
                                                            if($v["visitor_id"]!= $sessuserinfo["user_id"]){ break; } 
                                                        } 
                                                    } 
                                                ?>
                                                <dl class="child_box1_lf">
                                                    <dt>
                                                        <a target="_blank" class="name_box1_lf" href="home2.0.php?h=<?php echo $v["visitor_id "];?>">
                                                            <img src="<?php if($v['visitor_ico']){ echo str_replace(" _small ","",$v['visitor_ico']);}else{echo "/skin/default/jooyea/images/d_ico_1.gif ";}?>" width="38" height="38" alt="<?php echo filt_word($v[" visitor_name "]);?>">
                                                        </a>
                                                    </dt>
                                                    <dd style="width:410px;">
                                                        <div class="somethingnew_tr" id='sub_com_<?php echo $v['comment_id'];?>'>
                                                            <a class="name_box1_lq" href="home2.0.php?h=<?php echo $v["visitor_id"];?>">
                            ...
                            <dl class="viewer_lq" id="111115">
                                <dt class="img_box1_lq">
                                    <a target="_blank" href="home2.0.php?h=<?php echo $val[guest_user_id];?>">
                                        <img src="/rootimg.php?src=<?php echo $val[guest_user_ico];?>&h=82&w=82&z=1" width="48" height="48">
                                    </a>
                                </dt>
                                <dd class="viewer_info1_lq">
                                    <p>
                                        <span class="viewdate_lq send_time" dateutc="<?php echo substr($val['add_time'], 0, 16);?>">
                                            <?php echo substr($val[ 'add_time'], 0, 16);?>
                                        </span>
                                    </p>
                                    <p>
                                        <span class="viewdate_lq  visitors_name_lf" title="<?php echo $val[guest_user_name];?>">
                                        </span>
                                    </p>
                                    <p>
                                        <span class="viewdate_lq  visitors_name_lf" title="<?php echo $val[guest_user_name];?>">
