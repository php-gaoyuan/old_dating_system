...
2、According to your designated time, we will arrange to dispatch the order for free；";
	var $gf_con7="Bestellungen des erfolgreichen bezahlt，Wir haben nicht behandeln。";
	var $gf_con6="Leck einzelne Ausgabe";
	...
	var $gf_con0="Führung";
	var $gf_nanshi="Männer";
	var $gf_nvshi="Frau";
	var $gf_liwuwenhua="Geschenk-Kultur";
	var $gf_changjianwenti="häufig gestellte Fragen";
	var $gf_put="senden";
	var $gf_putin="Received";
	var $gf_putout="einreichen";

	var $gf_forto="Sent";
	var $gf_selfriend="Wählen Freunde";
	var $gf_gift="Geschenk";

	var $gf_putong="Friendly greetings";
	var $gf_gaoji="Flower Teaser";
	var $gf_chaoji="Birthday wishes";
	var $gf_zengyan="Ratschläge";
	var $gf_giveto="erhalten";
	var $gf_mess_0="Kein Objekt。";
	var $gf_mess_1="Kein Objekt!";
	var $gf_mess_2="Keine Geschenke!";
	var $gf_mess_3="Integral zu";
	var $gf_mess_4="Erfolgreich gesendet!";
	var $gf_mess_5="Saldo nicht ausreicht, bitte senden Sie weitere Geschenke nach dem Aufladen.";
	var $gf_mess_6="Das System sendet";
	var $gf_mess_7="Geschenk abgelehnt";
	var $gf_mess_8="Ablehnung der Ihr Geschenk";

	var $gf_mess_9="in";
	var $gf_mess_10="Dies stellte ein Geschenk für Sie";
	var $gf_mess_11="empfangen?";
	var $gf_mess_12="empfangen";
	var $gf_mess_13="abgelehnt";
	var $gf_mess_14="Ich will zu viel";
	var $gf_mess_15="entfernen";

	var $gf_mess_16="Sie";
	var $gf_mess_17="präsentiert auf";
	var $gf_mess_18="Dieses Geschenk";	
}
?>
