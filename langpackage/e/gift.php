...
class giftlp{
	...
	var $jingmei="Подарки";
	var $taocan="Романтический пакет";
	var $qiaokeli="шоколад";
	var $xianhua="Цветы";
	var $langman="День святого Валентина";
	var $gf_zanshimeiyou="Никаких подарков необязательные";
	var $gf_goumai="Купить сейчас";
	var $gf_shuliang="количество";
	var $gf_caizhi="материал";
	var $gf_jiage="цена";
	var $gf_fanhui="Вернуться к списку";
	var $gf_xiangqing="Информация о подарке";
...
2、According to your designated time, we will arrange to dispatch the order for free.；";
	...
	var $gf_nanshi="Gifts for Men";
	var $gf_nvshi="Gifts for Women";
	var $gf_liwuwenhua="Gifts Culture";
	var $gf_changjianwenti="FAQ";
	var $gf_put="Подарки";
	var $gf_putin="Подарки в редакцию";
	var $gf_putout="Отправить подарок";

	var $gf_forto="посланный";
	var $gf_selfriend="Выберите друзей";
	var $gf_gift="подарок";

	var $gf_putong="Обыкновенные подарков";
	var $gf_gaoji="Старший подарков";
	var $gf_chaoji="Правда подарок";
	var $gf_zengyan="Слова совет";
	var $gf_giveto="получать";
	var $gf_mess_0="Получить объект не существует";
	var $gf_mess_1="Также не выбрать, чтобы быть пожертвованные объекты!";
	var $gf_mess_2="Также не выбрать, чтобы быть свободным даром!";
	var $gf_mess_3="Текущая точка";
	var $gf_mess_4="Подарки успешно отправлено!";
	var $gf_mess_5="Отсутствие баланса, пополнения Пожалуйста, пришлите больше подарков。";
	var $gf_mess_6="система отправляет";
	var $gf_mess_7="Подарок отклонил";
	var $gf_mess_8="Отказ от Вашего подарка";

	var $gf_mess_9="в";
	var $gf_mess_10="Это дало в подарок Вам";
	var $gf_mess_11="Независимо от того, чтобы получить?";
	var $gf_mess_12="получать";
	var $gf_mess_13="Отклонено";
	var $gf_mess_14="Я хочу много";
	var $gf_mess_15="удалять";

	var $gf_mess_16="вы";
	var $gf_mess_17="Представлено";
	var $gf_mess_18="Этот подарок";	
}
?>
