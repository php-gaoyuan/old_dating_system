...
class loginlp{
	...
	var $l_lock_u="К сожалению, ваш аккаунт был заблокирован или неактивным";
	var $l_loading="Введите логин и пароль соединения...";
	...
	var $l_momber_login="Вход для зарегистрированных пользователей";
	var $l_forget_pw="Забыли пароль？";
	var $l_momber_register="Член регистрации";
	...
	var $l_sex="Пол</label>";
	var $l_success="Успешная посадка";
	var $l_username="Имя пользователя не может быть пустым！";
