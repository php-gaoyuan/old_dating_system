<?php
class msglp{
	var $qingchongzhi="L'or est insuffisante, s'il vous plaît recharger";
	var $geshicuowu="格式错误";
	var $tupianguoda="图片过大";
	var $m_fanhuiliebiao="返回列表";
	var $m_qbsc="全部删除";
	var $m_jrgrzy="进入个人首页";
	var $m_jinbibuzu="金币不足，请充值 ";
	var $m_fanyitishi="是否继续？翻译邮件需要金币 ";
	...
	var $m_cread_put = "您的金币不足，请充值购买邮票或升级后，可发送更多信息。";
