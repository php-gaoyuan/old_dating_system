...
########################井号中间的是新加的################################
	...
	var $help_8="如果您在missinglovelove的充值頁面無法成功充值，請先查看妳的信用卡是否有問題然後更換浏覽器重新嘗試。有時您也可以選擇聯系貝寶（比如在系統提示'您的信用卡不能用于支付這筆交易'的情況下）。如果各種方法都嘗試過後仍舊無法成功充值，請將詳細情況告訴我們，比如您使用的是哪種充值方式，有何錯誤提示？使用哪種浏覽器？爲了協助我們技術人員快速查找原因幫妳解決問題，請您盡可能將出錯頁面截圖發給我們。";
