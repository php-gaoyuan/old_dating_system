...
########################井号中间的是新加的################################
	...
	var $js_24="購買金幣給自己或朋友，用來兌換高級身份和享有更多的功能";
	...
	var $help_3="壹金幣需要多少美元？";

	var $help_4="1枚金幣大約需要1美元。";

	var $help_5="充值有優惠嗎？";

	var $help_6="充值1金幣需1美元，目前充值沒有優惠。";

	var $help_7="在充值頁面無法成功充值？";

	var $help_8="如果您在lovelove的充值頁面無法成功充值，請先查看妳的信用卡是否有問題然後更換浏覽器重新嘗試。有時您也可以選擇聯系貝寶（比如在系統提示'您的信用卡不能用于支付這筆交易'的情況下）。如果各種方法都嘗試過後仍舊無法成功充值，請將詳細情況告訴我們，比如您使用的是哪種充值方式，有何錯誤提示？使用哪種浏覽器？爲了協助我們技術人員快速查找原因幫妳解決問題，請您盡可能將出錯頁面截圖發給我們。";
...
########################################################
	...
	var $er_goumaijinbi="購買金幣，1金幣只需1 USD";

	var $er_chongzhijine="選擇充值金額:";

	var $er_20jinbi="30金幣 需要30 USD";

	var $er_50jinbi="50金幣 需要50 USD";

	var $er_100jinbi="100金幣 需要100 USD";

	var $er_200jinbi="200金幣 需要200 USD";

	var $er_500jinbi="500金幣 需要500 USD";

	var $er_1000jinbi="1000金幣 需要1000 USD";
	...
	var $er_gj_1y="1 個月（100金幣）";

	var $er_gj_3y="3 個月（260金幣）";

	var $er_gj_6y="6 個月（480金幣）";

	var $er_gj_1n="1 年（880金幣）";



	var $er_vip="高級會員升級";

	var $er_vip_1y="1 個月（14.9金幣）";

	var $er_vip_3y="3 個月（30金幣）";

	var $er_vip_6y="6 個月（60金幣）";

	var $er_vip_1n="1 年（120金幣）";



	var $er_zvip="VIP會員升級";
	var $er_zvip_1y="1 個月（30 USD）";
	var $er_zvip_3y="3 個月（70 USD）";
	var $er_zvip_6y="6 個月（110 USD）";
	var $er_zvip_1n="1 年（180 USD）";
	...
	var $er_zvip_yj="藍鑽會員（199 USD）";

	var $er_yj_shuoming1 = "使用全站所有功能一直線上";



	var $er_tshi="<font color='#ce1221' style='font-weight:bold;'>購買金幣</font>：1金幣僅需0.99美元";

	var $er_mess="當前妳的帳號還有";

	var $er_mess2="金幣不足用于升級會員，現在去充值吧。";
