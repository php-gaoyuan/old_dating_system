...
class arrayhomelp{
	...
	var $ah_personal_space = "Miembros Actividades here";
	var $ah_groups_share = "Grupo / Compartir";
	var $ah_game_application = "aplicación de juego";
	var $ah_personal_space_detail = "<dd>Crea tu propio espacio, los registros de correos, las fotografías, las letras </ dd> <dd> disfrutar de la vida poco a poco..</dd>";
	...
	var $ah_after_friend = "成Después de un amigo, que puede discutir el tema, y la atención oportuna a las actualizaciones de los demás, también se puede jugar juegos divertidos ... <br /> Puede también rápida y fácilmente publicar su propio registro, subir fotos, la vida poco a poco récord con un amigo Compartir. ¿Qué <br /> estás esperando? Ven y únete a nosotros ahora。";
...
class loginlp{
	...
	var $l_wrong_pass="Error Contraseña de usuario!";
	var $l_lock_u="Lo sentimos, tu cuenta ha sido bloqueada";
	var $l_loading="Ingresa conexión...";
	var $l_email="número de cuenta";
	var $l_pass="contraseña";
	var $l_repass="Repita la contraseña";
	var $l_save_aco="Recordarme";
	var $l_hid="invisible";
	var $l_login="login";
	var $l_r_aco="Todavía no se ha abierto la cuenta de red fácil de poli？";
