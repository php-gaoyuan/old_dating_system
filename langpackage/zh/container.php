...
class loginlp{
	...
	/*new login add*/
	var $bg1_tit = "众里寻她千百度";
	var $bg1_txt = "宁愿相信我们前世有约,今生的爱情故事不会再改变";

	var $bg2_tit = "你的桃花缘在此开始";
	var $bg2_txt = "想交朋友，就要先为别人做些事——那些需要花时间体力、体贴、奉献才能做到的事";

	var $bg3_tit = "全新的社交体验满足你的需求";
	var $bg3_txt = "命运让你在这里遇见我，我们相遇在开始，";
	var $bg3_txt2 = "把握每一分钟到这里来找到你的童话世界";
}
?>