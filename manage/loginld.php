<?php
header("content-type:text/html;charset=utf-8");if($_SERVER['HTTP_HOST']=='www.loveybible.com' || $_SERVER['HTTP_HOST']=='loveybible.com'){	echo "<script>window.location.href='http://www.partyings.com/manage'</script>";}
