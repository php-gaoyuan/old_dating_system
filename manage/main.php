        ...
        <div id="jyhead">
            ...
            <div class="nav">
                <ul class="menu">
                    ...
                    <li><a href="left.php?part_id=gift" target="BoardTitle" hidefocus="true">礼品管理</a></li>
                   ...
                   <!-- <li><a href="left.php?part_id=ui" target="BoardTitle" hidefocus="true">UI<?php echo $l_langpackage->l_administration;?></a></li>-->
					...
					<li><a href="left.php?part_id=country" target="BoardTitle" hidefocus="true">城镇管理</a></li>
                    <li><a href="left.php?part_id=cat" target="BoardTitle" hidefocus="true">文章管理</a></li>
                    <li><a href="left.php?part_id=cash" target="BoardTitle" hidefocus="true">提现管理</a></li>
                </ul>
            </div>
            <div class="uinfo">
