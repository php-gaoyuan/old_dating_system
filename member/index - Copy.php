	  ...
	  <form id="User_Login" name="User_Login" method="post" action="" onSubmit="return CheckForm_UserLogin()">
		<table width="100%" border="0">
		  <tr>
			...
			<td width="55%" height="50"><input name="email" type="text" class="input_01" id="email" maxlength="30" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td height="50"><input name="Submit" type="submit" class="btn_01" value=" " />
			  <!--<a href="Guest_Reg.php">[注册]</a>--></td>
