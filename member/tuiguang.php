  ...
  <tr>
	<td>
		<dl class="invite_info">
			<dt><strong>邀请更多的朋友和同事加入www.partyings.com！</strong></dt>
			<dd>您可以通过QQ、MSN等IM工具，或者发送邮件，把下面的链接告诉你的好友，邀请他们加入进来。</dd>
			<dd>http://www.partyings.comn/?tuid=<?php echo get_session('wz_userid');?></dd>
...
www.partyings.com上建立了个人主页，邀请你也加入并成为我的好友。
加入到我的好友中，你就可以通过我的个人主页了解我的近况，分享我的照片，随时与我保持联系。
邀请附言：
点击以下链接，接受好友邀请:http://www.partyings.com/?tuid=<?php echo get_session('wz_userid');?></textarea>
