...
<div class="tabs">
	<ul class="menu">
        <li><a href="modules2.0.php?app=album" hidefocus="true"><?php echo $a_langpackage->a_mine;?></a></li>
        <li class="active"><a href="modules2.0.php?app=album_friend" hidefocus="true"><?php echo $a_langpackage->a_friend;?></a></li>
    </ul>
</div>
<div class="album_holder">
  ...
  <?php $is_pri=check_pri($val['user_id'],$val['privacy']);?>
		<dl class="list_album" onmouseover="this.className += ' list_album_active';" onmouseout="this.className='list_album';" >
			<dt><a href='<?php echo $is_pri ? "modules2.0.php?app=photo_list&album_id=".$val['album_id']."&user_id=".$val['user_id']:"javascript:void(0)";?>'><img src=<?php echo $is_pri ? $val['album_skin'] : "skin/$skinUrl/images/errorpage.gif";?> onerror="parent.pic_error(this)" class='user_ico'></a></dt>
