...
?><?php
	...
	if($ses_uid==$host_id){
		$no_pht = $a_langpackage->a_no_upl.",<a href='modules2.0.php?app=photo_upload&album_id=".$album_id."'>".$a_langpackage->a_upl_pht."</a>";
	}else{
...
<div class="album_photo_box">
  <a href='<?php echo $is_pri ? rewrite_fun("modules2.0.php?app=photo&photo_id=".$val['photo_id']."&album_id=".$album_id."&user_id=".$user_id) : "javascript:void(0)";?>'>
