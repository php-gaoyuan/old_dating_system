...
<body id="iframecontent" oncontextmenu="return false;" style="height:1000px;">
<?php if($is_self=='Y'){?>
<div class="create_button"><a href="modules2.0.php?app=album_edit"><?php echo $a_langpackage->a_creat;?></a></div>
<div class="create_button"><a href="modules2.0.php?app=photo_upload&album_id=<?php echo $album_id;?>"><?php echo $a_langpackage->a_upload;?></a></div>
<?php }?>
<h2 class="app_album"><?php echo $a_who;?></h2>
<?php if($is_self=='Y'){?>
<div class="tabs">
	<ul class="menu">
        <li class="active"><a href="modules2.0.php?app=album" hidefocus="true"><?php echo $a_langpackage->a_mine;?></a></li>
        <li><a href="modules2.0.php?app=album_friend" hidefocus="true"><?php echo $a_langpackage->a_friend;?></a></li>
    </ul>
</div>
<?php }?>
<?php if($photo_row){?>
		...
		<div class="photo_showbox">
			<div class="sub_box">
				...
				<div class="photo_view">
					<img <?php if($is_self=='Y'){?>onmouseDown="menu_pop_show(event,this);"<?php }?> id='<?php echo $t_photo;?>:<?php echo $photo_row['photo_id'];?>:<?php echo $photo_row["privacy"];?>' style='display:none;max-widt:470px;width:100%' onerror="parent.pic_error(this)" onmousemove='turnover(this);' />
				...
				<div class="photo_operate">
					...
					<a href="modules2.0.php?app=photo_list&album_id=<?php echo $album_id;?>&user_id=<?php echo $url_uid;?>"><?php echo $a_langpackage->a_bak_list;?></a>
				</div>
				<?php }?>
			</div>
		</div>
	...
	<script type='text/javascript'>
		...
		function turnover(obj){
			...
			if(move_x >= show_width/2){
				...
				obj.onclick=function(){location.href="<?php echo $siteDomain;?>modules2.0.php?app=photo&photo_id=<?php echo $photo_id;?>&album_id=<?php echo $album_id;?>&prev_next=next&user_id=<?php echo $url_uid;?>"};
			}else{
				obj.style.cursor="URL(skin/<?php echo $skinUrl;?>/images/pre.cur),auto";
				obj.title='<?php echo $a_langpackage->a_page_up;?>';
				obj.onclick=function(){location.href="<?php echo $siteDomain;?>modules2.0.php?app=photo&photo_id=<?php echo $photo_id;?>&album_id=<?php echo $album_id;?>&prev_next=prev&user_id=<?php echo $url_uid;?>"};
			}
		}
	</script>
<?php }?>
