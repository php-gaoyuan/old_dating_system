...
?><?php
	...
	$titleStr='新问题';
	$goBackUrl='modules2.0.php?app=ask';
	...
	if($ask_id!=""){
		$titleStr='修改问题';
		$goBackUrl='modules2.0.php?app=ask_show&id='.$ask_id;
...
<body id="iframecontent">
    <div class="create_button"><a href="modules2.0.php?app=ask&mod=mine">我的问题</a></div>
