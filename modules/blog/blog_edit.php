...
?><?php
	...
	$goBackUrl='modules2.0.php?app=blog_list';
	$ulogTitle='';
	$usubPara='';
	$ulogTxt='';
	$album_id='';
  ...
  $tag='';
	...
	if($ulog_id!=""){
		...
		$goBackUrl='modules2.0.php?app=blog&id='.$ulog_id;
...
<body id="iframecontent">
    ...
    <div class="tabs">
			<ul class="menu">
				<li class="active"><a href="modules2.0.php?app=blog_list" hidefocus="true"><?php echo $titleStr;?></a></li>
			</ul>
    </div>
        ...
        function newCancel(){
         ...
         <table border="0">
                ...
                <td>
                    ...
                    <span id=sortManage>
                        &nbsp;<a onclick="newShow();return false;" href='javascript:;'><?php echo $b_langpackage->b_add_sort;?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='modules2.0.php?app=blog_manager_sort'><?php echo $b_langpackage->b_manage_sort;?></a>
                    </span>
                </td>
              </tr>
          </table>
