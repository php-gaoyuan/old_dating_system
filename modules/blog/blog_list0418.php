 ...
 * 如果您的模型要进行修改，请修改 models/home2.0.php
 *
...
//取得评论内容
	function get_mod_com(type_id,mod_id,start_num,end_num){
		...
		ajax_get_com.getInfo("modules2.0.php","GET","app","app=restore&mod_id="+mod_id+"&type_id="+type_id+"&start_num="+start_num+"&end_num="+end_num,function(c){get_com_callback(c,type_id,mod_id);});
	}
	//回复评论
...
<div class="user_box">
	<div class="user_status">
        <div class="user_content">
            ...
            <span class="time"><a href="javascript:;" onclick="frame_content.location.href='modules2.0.php?app=mood_more&user_id=<?php echo $holder_id;?>'"><?php echo $ah_langpackage->ah_more_mood;?></a></span>
        </div>
	</div>
</div>
<div class="clear"></div>
...
<!-- 	  <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules2.0.php?app=user_info&user_id=<?php echo $holder_id;?>&single=1';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_data;?></a></li> -->
	  <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules2.0.php?app=blog_list&user_id=<?php echo $holder_id;?>';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_log;?></a></li>
	  <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules2.0.php?app=album&user_id=<?php echo $holder_id;?>';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_album;?></a></li>
	  <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules2.0.php?app=share_list&user_id=<?php echo $holder_id;?>';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_share;?></a></li>
    <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules2.0.php?app=mood_more&user_id=<?php echo $holder_id;?>';return false;" hidefocus="true"><?php echo $mn_langpackage->mn_mood;?></a></li>
	    	...
	    	<div class="com_user">
	    	  ...
	    	  $guest_rs = api_proxy("guest_self_by_uid","*",$user_info['user_id'],10);
	    	  	...
	    	  	echo "<li>";
		    	  	...
		    	  	if($size == 0){
		    	  		echo "<img src=\"http://www.missinglovelove.com/rootimg.php?src=http://www.missinglovelove.com/skin/default/jooyea/images/d_ico_1.gif&h=82&w=82&z=1\" /></a>";
		    	  	}else{
		    	  		echo "<img src=\"http://www.missinglovelove.com/rootimg.php?src=$val[guest_user_ico]&h=82&w=82&z=1\" /></a>";
		    	  	}
		    	  	echo "<span>";
