	    	...
	    	<div class="com_user">
	    	  ...
	    	  $guest_rs = api_proxy("guest_self_by_uid","*",$user_info['user_id'],10);
	    	  	...
	    	  	echo "<li>";
		    	  	...
		    	  	if($size == 0){
		    	  		echo "<img src=\"http://www.partyings.com/rootimg.php?src=http://www.partyings.com/skin/default/jooyea/images/d_ico_1.gif&h=82&w=82&z=1\" /></a>";
		    	  	}else{
		    	  		echo "<img src=\"http://www.partyings.com/rootimg.php?src=$val[guest_user_ico]&h=82&w=82&z=1\" /></a>";
		    	  	}
		    	  	echo "<span>";
