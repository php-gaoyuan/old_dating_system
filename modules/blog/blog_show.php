...
<body id="iframecontent">
    <div class="create_button <?php echo $button_ctrl_his;?>"><a href="modules2.0.php?app=blog_friend&user_id=<?php echo $userid;?>"><?php echo $b_langpackage->b_re_list;?></a></div>
    <div class="create_button <?php echo $button_ctrl_mine;?>"><a href="modules2.0.php?app=blog_list&user_id=<?php echo $userid;?>"><?php echo $b_langpackage->b_re_list;?></a></div>
    <h2 id="page_title" class="app_blog"><?php echo $b_langpackage->b_scan;?></h2>
	<?php if($is_show){?>
	<dl class="log_list">
		<dt>
			<strong><?php echo filt_word($blog_row["log_title"]);?></strong><br />
			<span><?php echo $b_langpackage->b_sort;?>：<a href="modules2.0.php?app=blog_list&sort_id=<?php echo $blog_row['log_sort'];?>&sort_name=<?php echo urlencode($blog_row['log_sort_name']);?>&user_id=<?php echo $blog_row['user_id'];?>" title="<?php echo $b_langpackage->b_same_sort;?>"><?php echo empty($blog_row['log_sort_name'])? $b_langpackage->b_default_sort :filt_word($blog_row['log_sort_name']);?></a></span><span class="log_list_options"><?php echo $blog_row["add_time"];?></span>
    </dt>
        ...
        <dd><span><?php echo $b_langpackage->b_label;?>：<?php echo $blog_row['tag'];?></span>
          ...
          <?php if($blog_row['user_id']==$ses_uid){?>
					<span class="log_edit_link">
						<a href='modules2.0.php?app=blog_edit&id=<?php echo $blog_row["log_id"];?>'><?php echo $b_langpackage->b_edit;?></a>
					</span>
