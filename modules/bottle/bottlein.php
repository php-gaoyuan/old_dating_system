...
<body id="iframecontent">
    <div class="create_button"><a href="do.php?act=bott_pick"><?php echo $b_langpackage->b_find_one;?></a><a href="modules2.0.php?app=bott_creator"><?php echo $b_langpackage->b_send_one;?></a></div>
    ...
    <div class="tabs">
        <ul class="menu">
            ...
            <li><a href="modules2.0.php?app=bott_out" title="<?php echo $b_langpackage->b_send_bottle;?>" hidefocus="true"><?php echo $b_langpackage->b_send_bottle;?></a></li>
        </ul>
    </div>
...
<?php foreach($bottle_list as $key => $val){?>
        <tr>
            ...
            <td width="30"><a title='<?php echo $val["bott_title"];?>' href='modules2.0.php?app=bott_rpshow&id=<?php echo $val["bott_id"];?>&t=0'><img title="<?php echo $val["readed"]?$m_langpackage->m_have_read:$m_langpackage->m_unread;?>" src='skin/<?php echo $skinUrl;?>/images/mesread_<?php echo $val["readed"];?>.gif' /></a></td>
            ...
            <td><a title='<?php echo $val["bott_title"];?>' href='modules2.0.php?app=bott_rpshow&id=<?php echo $val["bott_id"];?>&t=0'><?php echo $val["bott_title"];?></a></td>
