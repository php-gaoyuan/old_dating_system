...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
            <li><a href="modules2.0.php?app=bott_in" title="<?php echo $m_langpackage->m_in;?>" hidefocus="true"><?php echo $b_langpackage->b_find_bottle;?></a></li>
...
<?php foreach($bottle_list as $key => $val){?>
	 <tr>
	   <td width="25">&nbsp;</td>
		 <td width="30"><a title='<?php echo $val["bott_title"];?>' href='modules2.0.php?app=bott_rpshow&id=<?php echo $val["bott_id"];?>&t=0'><img title="<?php echo $val["state"]?$m_langpackage->m_sed:$m_langpackage->m_have_access;?>" src='skin/<?php echo $skinUrl;?>/images/bottle<?php echo $val["readed"];?>.gif' /></a></td>
		 ...
		 <td><a title='<?php echo $val["bott_title"];?>' href='modules2.0.php?app=bott_rpshow&id=<?php echo $val["bott_id"];?>&t=1'><?php echo $val["bott_title"];?></a></td>
