 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/bottle/notice.html
 * 如果您的模型要进行修改，请修改 models/modules/bottle/notice.php
 *
...
if(filemtime("templates/default/modules/bottle/notice.html") > filemtime(__file__) || (file_exists("models/modules/bottle/notice.php") && filemtime("models/modules/bottle/notice.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/bottle/notice.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
