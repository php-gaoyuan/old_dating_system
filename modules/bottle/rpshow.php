...
<body id="iframecontent">
    <div class="create_button"><a href="modules2.0.php?app=bott_reply&reid=<?php echo $bott_id;?>"><?php echo $b_langpackage->b_reply;?></a><a href="modules2.0.php?app=bott_in"><?php echo $b_langpackage->b_back;?></a></div>
