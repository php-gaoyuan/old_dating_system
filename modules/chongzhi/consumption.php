...
<div class="tabs">
    <ul class="menu">
        ...
        <!--<li class="active"><a href="modules2.0.php?app=user_consumption" ><?php echo $er_langpackage->er_consumption_log; ?></a></li>-->
    ...
    <ul id="sec_Content">
        <li style="height:auto;padding: 10px 25px 10px 25px;">
            <table style="text-align:center;font-size:12px;width: 100%;">
                <tr>
                    <td height="35" style="font-weight:bold;"><?php echo $er_langpackage->er_onumber; ?></td>
                ...
                <?php foreach ($mp_list_rs as $rs) { ?>
                    <tr>
                        ...
                        <td><?php echo str_replace('{price}', $rs['funds'], gettypes($rs['type'])); ?></td>
