 ...
 * 如果您的模板要进行修改，请修�?templates/default/modules/���� default.html

 * 如果您的模型要进行修改，请修�?models/modules/���� default.php
...
<div class="snsidea"><a href="modules2.0.php?app=user_reg" hidefocus="true"><img src="skin/<?php echo $skinUrl;?>/images/sns_idea1.jpg" width="664" height="314" /></a></div>
  	...
  	<div class="login">
        ...
        <form name="login_form" method="post" onsubmit="return false;">
            ...
            <p><span><a href="modules2.0.php?app=user_forget" class="forget"><?php echo $ah_langpackage->ah_forgot_password;?>�?/a></span><input type="submit" onclick="login();" class="button"  name="loginsubm" id="loginsubm" hidefocus="true" value="<?php echo $l_langpackage->l_login;?>"></p>
        ...
        <div id="MainPromotionBanner">
            ...
            <div id="SlidePlayer">
                ...
                <ul class="Slides">
                    ...
                    <li><a href="home2.0.php?h=<?php echo $val['user_id'];?>" target="_blank"><img src="<?php echo $val['show_ico'];?>" alt="<?php echo $val['user_name'];?>" /></a></li>
    ...
    <div class="right_part">
        ...
        <?php foreach($user_rs as $val){?>
            ...
            <dl>
                ...
                <dt><a class="avatar" hidefocus="true" href="home2.0.php?h=<?php echo $val['user_id'];?>" target="_blank"><img src="<?php echo $val['user_ico'];?>" alt="<?php echo $val['user_name'];?>" /></a></dt>

                <dd><a href="home2.0.php?h=<?php echo $val['user_id'];?>" hidefocus="true" target="_blank"><?php echo sub_str($val['user_name'],5,true);?></a></dd>
