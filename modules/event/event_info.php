...
<body id="iframecontent">
  ...
  <div class="tabs">
    <ul class="menu">
    	<?php if($event_id){?>
      <li class="active"><a href="modules2.0.php?app=event_info&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_update_activity;?></a></li>
      <li><a href="modules2.0.php?app=event_member_manager&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_member_management;?></a></li>
    	...
    	<?php }?>
    	<?php if(!$event_id){?>
    	<li class="active"><a href="modules2.0.php?app=event_info" hidefocus="true"><?php echo $ef_langpackage->ef_launch_activity;?></a></li>
    	<?php }?>
    </ul>
  </div>
