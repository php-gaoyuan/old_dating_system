...
if(empty($my_pals_rs)){
	$isNull=1;
	$list_none="";
	$no_event=$no_event?$no_event:$ef_langpackage->ef_not_friends.', <a href="modules2.0.php?app=mypals_search">'.$ef_langpackage->ef_add_friend_now.'</a>';
}
?>
...
<div class="tabs">
  <ul class="menu">
    <li class="active"><a href="modules2.0.php?app=event_invite&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_invite_friends;?></a></li>
  </ul>
</div>
<?php if($isNull==0){?>
	...
	<?php foreach($my_pals_rs as $rs){?>
			<div class="group_user_list">
				<a class="avatar" href="home2.0.php?h=<?php echo $rs['pals_id'];?>" target="_blank">
				...
				<div><a href="home2.0.php?h=<?php echo $rs['pals_id'];?>" target="_blank">
