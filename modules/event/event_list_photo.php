...
<form id="data_list" name="data_list" action="do.php?act=event_del_photo&event_id=<?php echo $event_id;?>" method="post" onsubmit="return check_form(this);">
  ...
  <div class="tabs">
      <ul class="menu">
			...
			<li class="active"><a href="modules2.0.php?app=event_list_photo&event_id=<?php echo $event_id;?>&user_id=<?php echo $userid;?>" hidefocus="true"><?php echo $ef_langpackage->ef_photo;?></a></li>
      </ul>
  </div>

	<?php foreach($photo_rs as $val){?>
	<div class="album_photo_box">
	  <a href="modules2.0.php?app=event_show_photo&event_id=<?php echo $val['event_id'];?>&photo_id=<?php echo $val['photo_id'];?>&user_id=<?php echo $ses_uid;?>">
