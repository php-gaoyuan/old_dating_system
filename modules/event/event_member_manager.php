...
<div class="tabs">
  <ul class="menu">
    <li><a href="modules2.0.php?app=event_info&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_update_activity;?></a></li>
    <li class="active"><a href="modules2.0.php?app=event_member_manager&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_member_management;?></a></li>
	<li><a href="modules2.0.php?app=event_upload_photo&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_upload_photo;?></a></li>
  </ul>
</div>
<div class="search_friend">
	<select onchange="location.href='modules2.0.php?app=event_member_manager&event_id=<?php echo $event_id;?>&mod='+this.value;">
...
<table class="msg_inbox" cellspacing="1" cellpadding="1">
    ...
    <tr>
    	...
    	<td>
    		<a href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank"><?php echo $ef_langpackage->ef_select;?></a>
