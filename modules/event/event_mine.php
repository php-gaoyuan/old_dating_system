...
function event_exit(event_id){
	...
	event_add.getInfo("do.php","get","app","act=event_exit&event_id="+event_id,function(c){if(c!="") parent.Dialog.alert(c);location.href="modules2.0.php?app=event"}); 
}
function event_follow_cancel(event_id){
	var event_follow=new Ajax();
	event_follow.getInfo("do.php","get","app","act=event_follow_cancel&event_id="+event_id,function(c){if(c!="") parent.Dialog.alert(c);location.href="modules2.0.php?app=event"}); 
}
</script>
</head>
<body id="iframecontent">
	<?php if($is_self=='Y'){?>
	<div class="create_button"><a href="modules2.0.php?app=event_search"><?php echo $ef_langpackage->ef_search_activity;?></a></div>
	<div class="create_button"><a href="modules2.0.php?app=event_info"><?php echo $ef_langpackage->ef_launch_activity;?></a></div>
	<?php }?>
  <h2 class="app_event"><?php echo $str_title;?></h2>
  <?php if($is_self=='Y'){?>
  <div class="tabs">
    <ul class="menu">
      <li><a href="modules2.0.php?app=event_list&mod=all" hidefocus="true"><?php echo $ef_langpackage->ef_all_activity;?></a></li>
      <li><a href="modules2.0.php?app=event_list&mod=recom" hidefocus="true"><?php echo $ef_langpackage->ef_recommended_activity;?></a></li>
      <li><a href="modules2.0.php?app=event_list&mod=city" hidefocus="true"><?php echo $ef_langpackage->ef_same_city_activity;?></a></li>
      <li class='active'><a href="modules2.0.php?app=event" hidefocus="true"><?php echo $ef_langpackage->ef_my_activity;?></a></li>
    </ul>
  </div>
	<?php }?>
	<?php foreach($event_rs as $rs){?>
        ...
        <div class="group_control">
				<?php if($is_self=='Y'){?>
					...
					<a class="<?php echo $action['manage'];?>" href="modules2.0.php?app=event_info&event_id=<?php echo $rs['event_id'];?>"><?php echo $ef_langpackage->ef_activity_management;?></a>
        ...
        <?php }?>
				...
				<div class="group_photo">
					<a href='modules2.0.php?app=event_space&event_id=<?php echo $rs["event_id"];?>&user_id=<?php echo $url_uid;?>'><img src="<?php echo $rs['poster'];?>" width='100px' height='100px' alt="<?php echo $rs['title'];?>" onerror="parent.pic_error(this)" /></a>
				</div>
				<dl class="group_list">
					<dt><a href='modules2.0.php?app=event_space&event_id=<?php echo $rs["event_id"];?>&user_id=<?php echo $url_uid;?>'><?php echo filt_word($rs['title']);?></a></dt>
  ...
  <div class="clear"></div>
	...
	<div class="guide_info <?php echo $list_none;?>">
		...
		<?php if($is_self=='Y'){?>
		<a href="modules2.0.php?app=event_info"><?php echo $ef_langpackage->ef_initiate_activity;?></a>
		<?php }?>
	</div>
</body>
</html>