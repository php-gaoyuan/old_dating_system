...
<body id="iframecontent">
  ...
  <div class="tabs">
    <ul class="menu">
		<li><a href="modules2.0.php?app=event_space&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_activity;?></a></li>
		<li><a href="modules2.0.php?app=event_member&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_member;?></a></li>
		<li class="active"><a href="modules2.0.php?app=event_list_photo&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_photo;?></a></li>
    </ul>
  </div>
<?php if($photo_row){?>
		...
		<div class="photo_showbox">
			<div class="sub_box">
				...
				<div class="photo_operate">
					...
					<a href="modules2.0.php?app=event_list_photo&event_id=<?php echo $event_id;?>"><?php echo $a_langpackage->a_bak_list;?></a>
				</div>
	...
	<script type='text/javascript'>
		...
		function turnover(obj){
			...
			if(move_x >= show_width/2){
				...
				obj.onclick=function(){location.href="modules2.0.php?app=event_show_photo&event_id=<?php echo $event_id;?>&photo_id=<?php echo $photo_id;?>&prev_next=next&user_id=<?php echo $url_uid;?>"};
			}else{
				obj.style.cursor="URL(skin/<?php echo $skinUrl;?>/images/pre.cur),auto";
				obj.title='<?php echo $a_langpackage->a_page_up;?>';
				obj.onclick=function(){location.href="modules2.0.php?app=event_show_photo&event_id=<?php echo $event_id;?>&photo_id=<?php echo $photo_id;?>&prev_next=prev&user_id=<?php echo $url_uid;?>"};
			}
		}
	</script>
<?php }?>
