...
function join_event(event_id,fellow,template){
	...
	event_add.getInfo("do.php?act=event_join","post","app","event_id="+event_id+"&fellow="+fellow+"&template="+template,function(c){parent.Dialog.alert(c);location.href="modules2.0.php?app=event_space&event_id="+event_id});
}
...
function event_edit_apply(event_id,fellow,template){
	var event_add=new Ajax();
	event_add.getInfo("do.php?act=event_edit_apply","post","app","event_id="+event_id+"&fellow="+fellow+"&template="+template,function(c){parent.Dialog.alert(c);location.href="modules2.0.php?app=event_space&event_id="+event_id});
}


function event_exit(event_id){
	var event_add=new Ajax();
	event_add.getInfo("do.php","get","app","act=event_exit&event_id="+event_id,function(c){if(c!="") parent.Dialog.alert(c);location.href="modules2.0.php?app=event_space&event_id="+event_id});
}
function event_follow_cancel(event_id){
	var event_follow=new Ajax();
	event_follow.getInfo("do.php","get","app","act=event_follow_cancel&event_id="+event_id,function(c){if(c!="") parent.Dialog.alert(c);location.href="modules2.0.php?app=event_space&event_id="+event_id});
}
</script>
</head>
...
<?php if($is_self=='Y'){?>
<div class="create_button"><a href="modules2.0.php?app=event_list&mod=all" hidefocus="true"><?php echo $ef_langpackage->ef_all_activity;?></a></div>
<?php }?>
<?php if($status>2 && $is_self=='Y'){?>
<div class="create_button">
	<a href="modules2.0.php?app=event_upload_photo&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_upload_photo;?></a>
</div>
<?php }?>
...
<div class="tabs">
	<ul class="menu">
		<li class="active"><a href="modules2.0.php?app=event_space&event_id=<?php echo $event_id;?>&user_id=<?php echo $userid;?>" hidefocus="true"><?php echo $ef_langpackage->ef_activity;?></a></li>
		<li><a href="modules2.0.php?app=event_member&event_id=<?php echo $event_id;?>&user_id=<?php echo $userid;?>" hidefocus="true"><?php echo $ef_langpackage->ef_member;?></a></li>
		<li><a href="modules2.0.php?app=event_list_photo&event_id=<?php echo $event_id;?>&user_id=<?php echo $userid;?>" hidefocus="true"><?php echo $ef_langpackage->ef_photo;?></a></li>
	</ul>
</div>
        ...
        <div class="evt_cnt">
            ...
            <?php if($is_doing){?>
						<?php if($is_join>1){?>
							...
							<li><a class="regular-btn" href="modules2.0.php?app=event_invite&event_id=<?php echo $event_id;?>"><?php echo $ef_langpackage->ef_invite_friends;?></a></li>
							<?php }?>
              ...
              <li><a class="regular-btn" href="javascript:void(0);" onclick="if(confirm('<?php echo $ef_langpackage->ef_confirm_exit;?>')){event_exit(<?php echo $event_id;?>);}"><?php echo $ef_langpackage->ef_exit_activity;?></a></li>
					...
					<?php if($is_self=='Y' && $is_join>=3){?>
						<li><a class="regular-btn" href="modules2.0.php?app=event_info&event_id=<?php echo $event_id;?>"><?php echo $ef_langpackage->ef_activity_management;?></a></li>
					<?php }?>
            </ul>
...
<div class="rs_head">
	<a class="right" href="modules2.0.php?app=event_member&event_id=<?php echo $event_id;?>&user_id=<?php echo $userid;?>"><?php echo $ef_langpackage->ef_more;?></a><?php echo $ef_langpackage->ef_activity_members;?>
</div>

<?php foreach($event_members as $rs){?>
<div class="group_user_list">
    <a class="avatar" href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank">
  ...
  <div><a href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank"><?php echo sub_str($rs['user_name'],5,true);?></a></div>
</div>
<?php }?>

<div class="rs_head">
	<a class="right" href="modules2.0.php?app=event_list_photo&event_id=<?php echo $event_id;?>&user_id=<?php echo $userid;?>"><?php echo $ef_langpackage->ef_more;?></a><?php echo $ef_langpackage->ef_album;?>
</div>

<?php foreach($photo_rs as $rs){?>
<div class="evt_album">
	<a href="modules2.0.php?app=event_show_photo&event_id=<?php echo $event_id;?>&photo_id=<?php echo $rs['photo_id'];?>&user_id=user_id=<?php echo $url_uid;?>">
