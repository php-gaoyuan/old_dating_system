...
<div class="tabs">
	<ul class="menu">
    	...
    	<li><a href="modules2.0.php?app=event_member_manager&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_member_management;?></a></li>
		<li class="active"><a href="modules2.0.php?app=event_upload_photo&event_id=<?php echo $event_id;?>" hidefocus="true"><?php echo $ef_langpackage->ef_upload_photo;?></a></li>
	</ul>
</div>
	...
	<tr>
		<td height="100%">
			...
			function getKeepupUrl(){
			  return "modules2.0.php?app=event_upload_photo&event_id=<?php echo $event_id;?>";
			}
			
			function getSuccUrl(){
				return "modules2.0.php?app=event_update_photo&id=<?php echo $event_id;?>";
			}
