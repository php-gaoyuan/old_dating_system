...
?><?php foreach($mypals_rs as $val){?>
	<li>
		<a class="avatar" href="home2.0.php?h=<?php echo $val["pals_id"];?>" target="_blank" title="<?php echo $f_langpackage->f_fri;?>">
			<img src="<?php echo $val['pals_ico'];?>" />
		</a>
		<span class="name"><a href="home2.0.php?h=<?php echo $val["pals_id"];?>" target="_blank" title="<?php echo $f_langpackage->f_fri;?>"><?php echo sub_str(filt_word($val['pals_name']),6,true);?></a></span>
		<span>
