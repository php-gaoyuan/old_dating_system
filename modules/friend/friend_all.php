...
<div class="photo_view_box <?php echo $text_friend;?>">
	...
	<?php foreach($mypals_rs as $val){?>
		<!--<div class="friend_infobox" onmouseover="this.className = 'friend_infobox_active';"  onmouseout="this.className = 'friend_infobox';">
				...
				<a href="home2.0.php?h=<?php echo $val['pals_id'];?>" target="_blank" title="<?php echo $f_langpackage->f_fri;?>"><img src="<?php echo $val['pals_ico'];?>" width="43px" height="43px" /></a>
				</div>
				<div class="friend_infobox_info">
					<dl>
						<dt><a href="home2.0.php?h=<?php echo $val["pals_id"];?>" target="_blank" title="<?php echo $f_langpackage->f_fri;?>"> <?php echo sub_str(filt_word($val['pals_name']),6,true);?></a></dt>
			...
			<li>
				<div class="photo">
				<a class="avatar" href="home2.0.php?h=<?php echo $val['pals_id'];?>" target="_blank" title="<?php echo $f_langpackage->f_fri;?>"><img src="<?php echo $val['pals_ico'];?>" /></a>
				</div>
					<dl>
						<dt><a href="home2.0.php?h=<?php echo $val["pals_id"];?>" target="_blank" title="<?php echo $f_langpackage->f_fri;?>"> <?php echo sub_str(filt_word($val['pals_name']),6,true);?></a></dt>
						<dd><?php echo $val['pals_sort_name'];?></dd>
