...
<body id="iframecontent">
    ...
    <div class="tabs">
      <ul class="menu">
        <li><a href="modules2.0.php?app=group" hidefocus="true"><?php echo $g_langpackage->g_mine;?></a></li>
        <li class="active"><a href="modules2.0.php?app=group_hot" hidefocus="true"><?php echo $g_langpackage->g_hot;?></a></li>
      </ul>
    </div>
		...
		<div class="group_box" onmouseover="this.className = 'group_box_active';" onmouseout="this.className='group_box';">
			<div class="group_box_content">
				...
				<div class="group_photo">
					<a href='modules2.0.php?app=group_space&group_id=<?php echo $rs["group_id"];?>&user_id=<?php echo $url_uid;?>'><img src='<?php echo $rs['group_logo'];?>' width='100px' height='100px' alt="<?php echo $rs['group_name'];?>" onerror="parent.pic_error(this)" /></a>
				</div>
				<dl class="group_list">
					...
					<dd><?php echo $g_langpackage->g_founder;?>：<a href='home2.0.php?h=<?php echo $rs["add_userid"];?>' target="_blank"><?php echo filt_word($rs['group_creat_name']);?></a></dd>
