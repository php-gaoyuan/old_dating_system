...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
            ...
            <li class="active"><a href="modules2.0.php?app=group_info_manager&group_id=<?php echo $group_id;?>" title="<?php echo $g_langpackage->g_info_change;?>"><?php echo $g_langpackage->g_info_change;?></a></li>
