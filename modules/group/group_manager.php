...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
            <li class="active"><a href="modules2.0.php?app=group_manager&group_id=<?php echo $group_id;?>" title="<?php echo $g_langpackage->g_info;?>" class="nowbutl"><?php echo $g_langpackage->g_info;?></a></li>
            ...
            <li><a href="modules2.0.php?app=group_member_manager&group_id=<?php echo $group_id;?>" title="<?php echo $g_langpackage->g_manage_member;?>"><?php echo $g_langpackage->g_manage_member;?></a></li>
