...
<body id="iframecontent">
    <div class="create_button"><a href="modules2.0.php?app=group"><?php echo $g_langpackage->g_return;?></a></div>
    <h2 class="app_group"><?php echo $g_langpackage->g_manage;?></h2>
    <div class="tabs">
        <ul class="menu">
            <li><a href="modules2.0.php?app=group_manager&group_id=<?php echo $group_id;?>" title="<?php echo $g_langpackage->g_info;?>" class="nowbutl"><?php echo $g_langpackage->g_info;?></a></li>
            <li><a href="modules2.0.php?app=group_info_manager&group_id=<?php echo $group_id;?>" title="<?php echo $g_langpackage->g_info_change;?>"><?php echo $g_langpackage->g_info_change;?></a></li>
            <li class="active"><a href="modules2.0.php?app=group_member_manager&group_id=<?php echo $group_id;?>" title="<?php echo $g_langpackage->g_manage_member;?>"><?php echo $g_langpackage->g_manage_member;?></a></li>
            <li><a href="modules2.0.php?app=group_space&group_id=<?php echo $group_id;?>" title="<?php echo $g_langpackage->g_en_space;?>"><?php echo $g_langpackage->g_en_space;?></a></li>
        </ul>
    </div>
...
<table class="msg_inbox" cellspacing="1" cellpadding="1">
    ...
    <tr>
    	...
    	<td>
    		<a href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank"><?php echo $g_langpackage->g_examine;?></a>
