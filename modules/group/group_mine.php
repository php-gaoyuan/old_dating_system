...
<body id="iframecontent">
  <?php if($is_self=='Y'){?>
  <div class="create_button"><a href="modules2.0.php?app=group_select" hidefocus="true"><?php echo $g_langpackage->g_search_group;?></a></div>
  <div class="create_button"><a href="modules2.0.php?app=group_creat"><?php echo $g_langpackage->g_creat;?></a></div>
  <?php }?>
  ...
  <?php }?>
	<?php foreach($group_rs as $rs){?>
		<div class="group_box" onmouseover="this.className = 'group_box_active';" onmouseout="this.className='group_box';">
          ...
          <a href='modules2.0.php?app=group_space&group_id=<?php echo $rs["group_id"];?>&user_id=<?php echo $url_uid;?>'><?php echo $g_langpackage->g_en_space;?></a>
          ...
          <a class="<?php echo $action['manage'];?> <?php echo $show_mine;?>" href="modules2.0.php?app=group_manager&group_id=<?php echo $rs['group_id'];?>"><?php echo $g_langpackage->g_manage;?></a>
        ...
        <div class="group_photo"><a href='modules2.0.php?app=group_space&group_id=<?php echo $rs["group_id"];?>&user_id=<?php echo $url_uid;?>'><img src="<?php echo $rs['group_logo'] ? $rs['group_logo'] : 'uploadfiles/group_logo/default_group_logo.jpg';?>" width='100px' height='100px' alt="<?php echo $rs['group_name'];?>" onerror="parent.pic_error(this)" /></a></div>
				<dl class="group_list">
					<dt><a href='modules2.0.php?app=group_space&group_id=<?php echo $rs["group_id"];?>&user_id=<?php echo $url_uid;?>'><?php echo filt_word($rs['group_name']);?></a></dt>
