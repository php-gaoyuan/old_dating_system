...
?><?php
	...
	$button_url="modules2.0.php?app=group&user_id=$userid";
	...
	if($is_self=='Y'){
		...
		$button_url="modules2.0.php?app=group_select";
...
<body id="iframecontent">
  ...
  <div class="tabs">
    <ul class="menu">
      <li class="active"><a href="modules2.0.php?app=group" hidefocus="true"><?php echo $g_langpackage->g_mine;?></a></li>
      <li><a href="modules2.0.php?app=group_hot" hidefocus="true"><?php echo $g_langpackage->g_hot;?></a></li>
    </ul>
  </div>
  <?php }?>
<?php if($is_show==1){?>
	...
	<div class="rs_head  <?php echo $show_data;?>">
		<div class="subject_search">
			<?php if(isset($role)&&$ses_uid!=''){?>
				<div class="right"><a href='modules2.0.php?app=group_subject&group_id=<?php echo $group_id;?>&user_id=<?php echo $userid;?>'><?php echo $g_langpackage->g_send;?></a></div>
			<?php }?>
			<form class="right mr10" onsubmit='return check_form();' method="post" action='modules2.0.php?app=search_subject&group_id=<?php echo $group_id;?>&user_id=<?php echo $userid;?>'>
		...
		<div class="poll_list_box">
			<div class="poll_user"><a class="avatar" href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank"><img src=<?php echo $rs['user_ico'];?> alt='<?php echo $rs['user_name'];?>' title='<?php echo $rs['user_name'];?>' /></a></div>
			<div class="subject_content">
				<dl>
					<dt><a href="modules2.0.php?app=group_sub_show&subject_id=<?php echo $rs['subject_id'];?>&group_id=<?php echo $group_id;?>&user_id=<?php echo $userid;?>"><?php echo filt_word($rs['title']);?></a></dt>
					<dd><a href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank"><?php echo filt_word($rs['user_name']);?></a> <span class='gray'><?php echo str_replace("{date}",$rs['add_time'],$g_langpackage->g_send_time);?></span></dd>
			...
			<div class="subject_status">
				<a href="modules2.0.php?app=group_sub_show&subject_id=<?php echo $rs['subject_id'];?>&group_id=<?php echo $group_id;?>&user_id=<?php echo $userid;?>"><?php echo $g_langpackage->g_examine;?></a>
