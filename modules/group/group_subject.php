...
<SCRIPT language=JavaScript src="servtools/ajax_client/ajax.js"></SCRIPT><SCRIPT language=JavaScript src="servtools/kindeditor/kindeditor.js"></SCRIPT>
...
<body id="iframecontent">
    <div class="create_button"><a href="modules2.0.php?app=group_space&group_id=<?php echo $group_id;?>&user_id=<?php echo $user_id;?>"><?php echo $g_langpackage->g_re_space;?></a></div>
	...
	<form action="do.php?act=group_send_sub&group_id=<?php echo $group_id;?>&user_id=<?php echo $u_id;?>"  method="post" style="margin-top:10px" name="myform" onSubmit="return CheckForm();">
		<table border="0" class="form_table" cellpadding="2" cellspacing="1" >
			...
			<tr>
				...
				<td style="line-height:1.5"><textarea name="CONTENT" id="msContent" class="textarea" style='width:560px;height:400px;_width:560px;'></textarea></td>
		   </tr>			<script>	var editor;	KindEditor.ready(function(K) {		editor = K.create('#msContent', {			allowFileManager : true,			width : '515px',			height:'300px',			items : [ 				'fontname', 'fontsize', '|','forecolor','hilitecolor','|',   'bold',				'italic', 'underline',    '|', 'justifyleft', 'justifycenter', 'justifyright','insertorderedlist', 'insertunorderedlist','|', 'emoticons',  'image',			],		});	});</script>
   		<!--<tr>
	      <th><?php echo $g_langpackage->g_pic;?>：</th>
	      <td>
	      	<div id="POPUP_KE_IMAGE">
	      		<iframe name="KindImageIframe" id="KindImageIframe" width="100%" height=30 align=top allowTransparency="true" scrolling=no src='modules2.0.php?app=upload_form' frameborder=0></iframe>
	      	</div>
		  </td>
		</tr>
		<tr>
			...
			<script type='text/javascript'>
				...
				function list_album_photos(){
					...
					get_album.getInfo("modules2.0.php","get","app","app=user_ico_select&type=blog_photo&album_id="+album_select_val,function(c){photos_list.innerHTML=c;});
					}
				}
			</script>			
			</tr>-->
