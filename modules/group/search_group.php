...
<body id="iframecontent">
  <div class="create_button"><a href="modules2.0.php?app=group_select"><?php echo $g_langpackage->g_return_search;?></a></div>
  ...
  <div class="tabs">
	...
	<?php foreach($search as $rs){?>
			...
			<div class="group_box_content">
				...
				<div class="group_photo"><a href='modules2.0.php?app=group_space&group_id=<?php echo $rs["group_id"];?>&user_id=<?php echo $url_uid;?>'><img src="<?php echo $rs['group_logo'] ? $rs['group_logo'] : 'uploadfiles/group_logo/default_group_logo.jpg';?>" width='100px' height='100px' onerror="parent.pic_error(this)" alt="<?php echo $rs['group_name'];?>" /></a></div>
				<dl class="group_list">
...
：<a href='home2.0.php?h=<?php echo $userid;?>' target="_blank"><?php echo filt_word($rs['group_creat_name']);?></a></dd>
