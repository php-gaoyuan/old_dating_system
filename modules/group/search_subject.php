...
<body id="iframecontent">
	<div class="create_button"><a href="javascript:location.href='modules2.0.php?app=group_space&group_id=<?php echo $group_id;?>&user_id=<?php echo $url_uid;?>'"><?php echo $g_langpackage->g_re_space;?></a></div>
...
<div class="poll_list_box <?php echo $isset_data;?>">
	<div class="poll_user">
		<a class="avatar" href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank"><img src=<?php echo $rs['user_ico'];?> alt='<?php echo $rs['user_name'];?>' title='<?php echo $rs['user_name'];?>' /></a>
		<a href="home2.0.php?h=<?php echo $rs['url_uid'];?>" target="_blank"><?php echo sub_str($rs['user_name'],6,true);?></a>
	</div>
	<div class="subject_content">
		<dl>
			<dt><a href="modules2.0.php?app=group_sub_show&subject_id=<?php echo $rs['subject_id'];?>&group_id=<?php echo $group_id;?>&user_id=<?php echo $url_uid;?>"><?php echo filt_word($rs['title']);?></a></dt>
			<dd><a href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank"><?php echo filt_word($rs['user_name']);?></a> <span class='gray' style='padding-left:15px'><?php echo str_replace("{date}",$rs['add_time'],$g_langpackage->g_send_time);?></span></dd>
	...
	<div class="subject_status">
		<a href="modules2.0.php?app=group_sub_show&subject_id=<?php echo $rs['subject_id'];?>&group_id=<?php echo $group_id;?>&user_id=<?php echo $url_uid;?>"><?php echo $g_langpackage->g_examine;?></a>
	</div>
</div>
<?php }?>
<?php echo page_show($isNull,$page_num,$page_total);?>
<div class="guide_info <?php echo $none_data;?>">
	<?php echo $g_langpackage->g_s_none_sub;?>,<a href='modules2.0.php?app=group_space&group_id=<?php echo $group_id;?>&user_id=<?php echo $url_uid;?>'><?php echo $g_langpackage->g_re_search;?></a>
</div>
