...
?><?php foreach($guest_rs as $val){?>
	<li>
		<a class="avatar" href="home2.0.php?h=<?php echo $val["guest_user_id"];?>" target="_blank" title="<?php echo $gu_langpackage->gu_see;?>">
			<img src="<?php echo $val['guest_user_ico'];?>" />
		</a>
		<span class="name"><a href="home2.0.php?h=<?php echo $val["guest_user_id"];?>" target="_blank" title="<?php echo $gu_langpackage->gu_see;?>"><?php echo sub_str(filt_word($val['guest_user_name']),6,true);?></a></span>
...
<!-- 	    	  	<li>
	    	  		<i onclick="del_com(2116)">×</i>
		    	  	<a href="home2.0.php?h=<?php echo $val["guest_user_id"];?>">
		    	  	<img src="<?php echo $val['guest_user_ico'];?>" /></a>
		    	  	<span>
			    	  	<a href="home2.0.php?h=<?php echo $val["guest_user_id"];?>"><?php echo $gu_langpackage->gu_see;?></a>
			    	  	<br />3 Day Ago
		    	  	</span>
	    	  	</li>
 -->
