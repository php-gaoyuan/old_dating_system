...
<dl class="msg_list">
	<div class="avatar"><a target="_blank" href='home2.0.php?h=<?php echo $val['from_user_id'];?>'><img src="<?php echo $val['from_user_ico'];?>" /></a></div>
	<dt><span><a target="_blank" href='home2.0.php?h=<?php echo $val['from_user_id'];?>'><?php echo filt_word($val['from_user_name']);?></a></span><span>[<?php echo $val['add_time'];?>]</span></dt>
...
<?php }?>
<div class="more"><a href="modules2.0.php?app=msgboard_more&user_id=<?php echo $userid;?>" class="highlight" title="<?php echo $mb_langpackage->mb_all_my_message;?>" href=""><?php echo $mb_langpackage->mb_full_message;?> »</a></div>
<?php }?>
<?php if(empty($mes_rs)){?>
