...
<script charset="utf-8" src="skin/<?php echo $skinUrl;?>/jquery-1.9.1.min.js"></script>
</head>
...
{    
  ...
  //       <?php if($check_acc == 2){?>
	 //         var gnl = confirm("<?php echo $two;?>");
		// 	if (gnl == true){
		// 		top.location.href='main2.0.php?app=user_pay';
		// 	    return false;
		// 	}else{
		// 	    return false;
		// 	}
	...
	var msContent=trim($("msContent").val());
	alert(msContent);
	if(msContent==''){
...
<body id="iframecontent">
    <div class="create_button"><a href="modules2.0.php?app=msg_creator"><?php echo $m_langpackage->m_creat;?></a></div>
          ...
          <tr>
			...
			<tr>
				<th valign="top"><?php echo $m_langpackage->m_cont;?>：</th>
				 <td><textarea maxlength="160" class="med-textarea" name="msContent" id="msContent" onKeyUp="return isMaxLen(this)"></textarea>
			...
			<tr>
				<th>&nbsp;</th>
				 ...
				 <td class="<?php echo $b_bak;?>">
				 	<input class="regular-btn" type="submit" value="<?php echo $m_langpackage->m_b_con;?>" />&nbsp;&nbsp;&nbsp;&nbsp;
				 	<input class="regular-btn" type="button" value="<?php echo $m_langpackage->m_b_bak;?>" onClick="location.href='modules2.0.php?app=msg_minbox'" />
				 </td>
		    </tr>
		</table>
       </form>
