...
<?php foreach($msg_inbox_rs as $key => $val){?>
        <tr>
            ...
            <td width="30"><a title='<?php echo $val["mess_title"];?>' href='modules.php?app=msg_rpshow&id=<?php echo $val["mess_id"];?>&t=2'><img title="<?php echo $val["readed"]?$m_langpackage->m_have_read:$m_langpackage->m_unread;?>" src='skin/<?php echo $skinUrl;?>/images/mesread_<?php echo $val["readed"];?>.gif' /></a></td>
