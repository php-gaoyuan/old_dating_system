...
function produce_invite_code(){
	...
	ajax_invite_code.getInfo("modules2.0.php?app=mypals_invite&invite_code=1","GET","app","",function(c){show_invite_code(c);});
}
...
function show_invite_code(invite_code){
	...
	diag.OKEvent = function(){window.location.href="modules2.0.php?app=mypals_invite";diag.close();};
	diag.show();
}
</script>
...
<body id="iframecontent">
  ...
  <div class="tabs">
      <ul class="menu">
          <li><a href="modules2.0.php?app=mypals" title="<?php echo $mp_langpackage->mp_list;?>"><?php echo $mp_langpackage->mp_list;?></a></li>
          <li><a href="modules2.0.php?app=mypals_request" title="<?php echo $mp_langpackage->mp_req;?>"><?php echo $mp_langpackage->mp_req;?></a></li>
          <li class="active"><a href="modules2.0.php?app=mypals_invite" title="<?php echo $mp_langpackage->mp_invite;?>"><?php echo $mp_langpackage->mp_invite;?></a></li>
...
<?php if(!$inviteCode){?>
		<dl class="invite_info">
			...
			<dd><textarea class="textarea" id="codeTxt" readonly style="height:280px; overflow-x:hidden">
...
<form action='modules2.0.php?app=mypals_invite&del_code=1' method='post' onsubmit="check_form()">
