...
<body id="iframecontent">
  <div class="create_button"><a href="modules2.0.php?app=mypals_search"><?php echo $mp_langpackage->mp_add;?></a></div>
  ...
  <div class="search_friend">
   ...
   <!-- <select id="sort_id" class="tleft" onchange="javascript:location.href='modules2.0.php?app=mypals&sort_id='+this.value">
  ...
  <div id="mypals_iframe">
	<?php if($mp_list_rs){?>
		<div class="friend_list">
			<div style="text-align:right;line-height:25px;margin-top:10px;"><a href="do.php?act=del_mypals" onclick='return confirm("If you delete all your friends")' style="display:inline-block;border-radius:5px;background:#CE0000;color:#fff;border:1px solid #F0F0F0;padding:0px 10px;">Delete All</a></div>
					...
					<li onmouseover='changeStyle(this,<?php echo $rs["id"];?>)' onmouseout='recoverStyle(this,<?php echo $rs["id"];?>)'>
						...
						<dl>
							...
							<div class="content_ch1" style="background:url(skin/default/jooyea/images/ch.jpg) ">
                                <a style="width:22px;height:22px;float:left;display:block" href="javascript:;" title="<?php echo $rf_langpackage->rf_liaotian;?>" onclick="top.open_chat('<?php echo $rs["pals_id"];?>');"></a>
                                <a style="width:22px;height:22px;float:left;display:block" href="javascript:;" title="<?php echo $rf_langpackage->rf_dazhaohu;?>" onclick="top.hi_action(<?php echo $rs["pals_id"];?>)"></a>
                                <a style="width:22px;height:22px;float:left;display:block" href="javascript:;" title="<?php echo $rf_langpackage->rf_fayoujian;?>" onclick="location.href='modules2.0.php?app=msg_creator&2id=<?php echo $rs["pals_id"];?>';return false;"></a>
