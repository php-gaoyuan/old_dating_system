	...
	<?php if($mp_list_rs){?>
		<div class="friend_list">
			...
			<ul id="tab0_content0" class="user_list">
				...
				<a style="width:22px;height:22px;float:left;display:block" href="javascript:;" title="<?php echo $rf_langpackage->rf_liaotian;?>" onclick="top.i_im_talkWin('<?php echo $rs["pals_id"];?>','imWin');"></a>
				...
				<a style="width:22px;height:22px;float:left;display:block" href="javascript:;" title="<?php echo $rf_langpackage->rf_fayoujian;?>" onclick="top.frame_content.location.href='modules.php?app=msg_creator&2id=<?php echo $rs["pals_id"];?>';return false;"></a>
