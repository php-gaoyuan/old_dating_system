...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
            ...
            <li class="active"><a href="modules2.0.php?app=mypals_sort" title="<?php echo $mp_langpackage->mp_m_sort;?>"><?php echo $mp_langpackage->mp_m_sort;?></a></li>
        </ul>
    </div> 
    <div class="rs_head"><a href='modules2.0.php?app=mypals&sort_id=0'><?php echo $mp_langpackage->mp_no_sort;?></a>（<?php echo $mp_langpackage->mp_def_sort;?>）</div>
		...
		<tr id="info_<?php echo $rs['id'];?>">
			<td>
					<div id="show_info_<?php echo $rs['id'];?>">
						<a href='modules2.0.php?app=mypals&sort_id=<?php echo $rs["id"];?>'><?php echo $rs['name'];?></a>
					</div>
			</td>
			<td>
