...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
          ...
          <li class="active"><a href="modules2.0.php?app=mypals_request" title="<?php echo $mp_langpackage->mp_req;?>"><?php echo $mp_langpackage->mp_req;?></a></li>
...
<?php foreach($request_rs as $rs){?>
	<tr>
		<td width="70" align="center">
			<div class="avatar"><a href="home2.0.php?h=<?php echo $rs['req_id'];?>" target="_blank"><img src='<?php echo $rs["req_ico"];?>' height='43px' width='43px' onerror="parent.pic_error(this)" /></a>
			</div>
		</td>
		<td width="180">
			<a href="home2.0.php?h=<?php echo $rs['req_id'];?>" target="_blank"><?php echo $rs["req_name"];?></a><?php echo $mp_langpackage->mp_add_you;?>
