 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/mypals/search_list.html
 * 如果您的模型要进行修改，请修改 models/modules/mypals/search_list.php
 *
...
if(filemtime("templates/default/modules/mypals/search_list.html") > filemtime(__file__) || (file_exists("models/modules/mypals/search_list.php") && filemtime("models/modules/mypals/search_list.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/mypals/search_list.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php 
...
<table width="1000" height="44" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div class="hymenu2">
	<ul>
	<li class="hydqbj"><a style="color:#FFFFFF;" href="modules.php?app=mypals_list" ><?php echo $mp_langpackage->mp_all_members;?></a></li>
