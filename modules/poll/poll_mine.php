...
<div class="tabs">
	<ul class="menu">
  	<li><a href="modules2.0.php?app=poll_list&m=new" hidefocus="true"><?php echo $pol_langpackage->pol_new;?></a></li>
  	<li><a href="modules2.0.php?app=poll_list&m=hot" hidefocus="true"><?php echo $pol_langpackage->pol_hot;?></a></li>
  	<li><a href="modules2.0.php?app=poll_list&m=reward" hidefocus="true"><?php echo $pol_langpackage->pol_reward;?></a></li>
  	<li class="active"><a href="modules2.0.php?app=poll_mine" hidefocus="true"><?php echo $pol_langpackage->pol_mine;?></a></li>
  </ul>
</div>
<?php }?>
...
<dl class="poll_list">
  <dt>
		<strong><a href="modules2.0.php?app=poll&p_id=<?php echo $rs["p_id"];?>&user_id=<?php echo $userid;?>"><?php echo $rs['subject'];?></a></strong>
