...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
		    <li class="active"><a href="modules2.0.php?app=privacy" title="<?php echo $pr_langpackage->pr_access;?>" ><?php echo $pr_langpackage->pr_access;?></a></li>
	...
	<table border="0" class='form_table'>
		...
		<tr>
			<td></td>
			<td><input type="submit" name="Submit" class="regular-btn" value="<?php echo $pr_langpackage->pr_button_action;?>" /><input type="button" name="Submit2" class="regular-btn" onclick="location.href='modules2.0.php?app=privacy'" value="<?php echo $pr_langpackage->pr_button_cancel;?>" /></td>
		</tr>  
	</table>
