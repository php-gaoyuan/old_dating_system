...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
		    <li><a href="modules2.0.php?app=privacy" title="<?php echo $pr_langpackage->pr_access;?>" ><?php echo $pr_langpackage->pr_access;?></a></li>
		    <li class="active"><a href="modules2.0.php?app=pr_inputmess" title="<?php echo $pr_langpackage->pr_inputmess;?>"><?php echo $pr_langpackage->pr_inputmess;?></a></li>
		    <li><a href="modules2.0.php?app=pr_reqcheck" title="<?php echo $pr_langpackage->pr_reqcheck;?>"><?php echo $pr_langpackage->pr_reqcheck;?></a></li>
        </ul>
    </div>
...
<table cellpadding="0" cellspacing="0" border="0" class='form_table'>
  ...
  <tr><td></td>
	<td><input type="submit" name="Submit" class="regular-btn" value="<?php echo $pr_langpackage->pr_button_action;?>" /><input type="button" name="Submit2" class="regular-btn" onclick="location.href='modules2.0.php?app=pr_inputmess'" value="<?php echo $pr_langpackage->pr_button_cancel;?>" /></td>
