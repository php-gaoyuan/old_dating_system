...
var jiathis_config = { 
	url: "http://www.partyings.com/home2.0.php?h=<?php echo $user_id; ?>",
	title: "<?php echo strip_tags($rs['title']); ?>", 
	summary:"partyings亚洲国际交友中心网站－You match with single girls by dating_单身男女的爱情公寓:" ,
	pic:"http://www.partyings.com/<?php echo $rs["user_ico"]; ?>"
} 
</script> 
