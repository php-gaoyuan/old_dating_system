 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/recentaffair/rec_affair13.html
 * 如果您的模型要进行修改，请修改 models/modules/recentaffair/rec_affair13.php
 *
...
if(filemtime("templates/default/modules/recentaffair/rec_affair13.html") > filemtime(__file__) || (file_exists("models/modules/recentaffair/rec_affair13.php") && filemtime("models/modules/recentaffair/rec_affair13.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/recentaffair/rec_affair13.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
