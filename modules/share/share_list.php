...
<?php if($is_self=='Y'){?>
<div class="share_box right" style="display:none">
...
<div class="tabs">
	<ul class="menu">
    <li class="active"><a href="modules2.0.php?app=share_list" hidefocus="true"><?php echo $s_langpackage->s_mine;?></a></li>
    <li><a href="modules2.0.php?app=share_friend" hidefocus="true"><?php echo $s_langpackage->s_friend;?></a></li>
  </ul>
</div>
<?php }?>
<?php foreach($share_rs as $rs){?>
<dl class="share_list">
  <dt><strong><a href="home2.0.php?h=<?php echo $rs["user_id"];?>" target="_blank"><?php echo filt_word($rs['user_name']);?></a></strong><?php echo filt_word($rs['s_title']);?>
