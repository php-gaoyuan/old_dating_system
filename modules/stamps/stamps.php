...
<div class="tabs">
    <ul class="menu">
        <li class="active"><a href="modules2.0.php?app=user_stamps" hidefocus="true"><?php echo $s_langpackage->s_change;?></a></li>
        <li><a href="modules2.0.php?app=user_help" hidefocus="true"><?php echo $er_langpackage->er_help;?></a></li>
        <li><a href="modules2.0.php?app=stamps_help" hidefocus="true"><?php echo $s_langpackage->s_guize;?></a></li>
    </ul>
</div>
