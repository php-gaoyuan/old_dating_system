 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/start13.html

 * 如果您的模型要进行修改，请修改 models/modules/start13.php
...
if(filemtime("templates/default/modules/start13.html") > filemtime(__file__) || (file_exists("models/modules/start13.php") && filemtime("models/modules/start13.php") > filemtime(__file__)) ) {

	tpl_engine("default","modules/start13.html",1);
...
function list_recent_affair(h_id,ra_type,is_more){
	...
	list_affair.getInfo("modules.php","get","app","app=recent_affair13&looklike="+rond+"&start_num="+start_num,function(c){
...
<div class="mypanel">
    ...
    <div class="myphoto">
		...
		<a hidefocus="true" target="frame_content" href="modules.php?app=user_ico"><img src="<?php echo get_sess_userico();?>" /></a>

		<ul>

			<li style="font-size: 12px;padding-left: 6px;height:20px;line-height:20px;text-align:left;">

				<a hidefocus="true" target="frame_content" href="modules.php?app=user_info"><?php echo $u_langpackage->u_info;?></a>

			</li>

			<li style="font-size: 12px;padding-left: 6px;height:20px;line-height:20px;text-align:left;">

				<a hidefocus="true" target="frame_content" href="modules.php?app=user_ico"><?php echo $u_langpackage->u_icon;?></a>
