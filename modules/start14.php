	  ...
	  <?php $is_pri=check_pri($val['user_id'],$val['privacy']);?>
			...
			<dl class="list_album" onmouseover="this.className += ' list_album_active';" onmouseout="this.className='list_album';" style="height:140px;width:20%;padding-left:130px;" >
				...
				<dd>
					...
					<span class="app_group" style="cursor: pointer;background: url('/skin/<?php echo $skinUrl;?>/images/appbg.gif') no-repeat scroll 0 -202px transparent;float:right;width:25px;height:15px;" onclick="location='/modules.php?app=msg_creator&2id=<?php echo $val["user_id"];?>&nw=2';">&nbsp;</span>
