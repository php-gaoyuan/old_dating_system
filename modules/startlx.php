 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/startlx.html

 * 如果您的模型要进行修改，请修改 models/modules/startlx.php
...
if(filemtime("templates/default/modules/startlx.html") > filemtime(__file__) || (file_exists("models/modules/startlx.php") && filemtime("models/modules/startlx.php") > filemtime(__file__)) ) {

	tpl_engine("default","modules/startlx.html",1);
