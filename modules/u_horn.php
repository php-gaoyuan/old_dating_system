...
<div style="min-height:100px;border:1px solid #ddd;margin-top:20px;text-align:left;padding:10px;">
	<?php 
		...
		<div class="use_laba"><a href="modules2.0.php?app=u_horn_fs"><?php echo $u_langpackage->shiyonglaba;?></a></div>
		
	<?php	}else{
			echo "<span>暂时没有喇叭！<a href='modules2.0.php?app=u_horn_buy&active=2' hidefocus='true'>去购买</a></span>";
		}
	?>
</div>
