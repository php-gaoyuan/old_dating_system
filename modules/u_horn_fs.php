...
function maxlengths(){
	if(document.getElementById('laba_content').value.length>200){
...
<div style="min-height:100px;border:1px solid #ddd;margin-top:20px;text-align:left;padding:10px;">
	...
	<textarea id="laba_content" name="content" maxlength="200"  onfocus="if(this.value=='<?php echo $u_langpackage->fasongneirong;?>'){this.value='';}" onblur="if(this.value==''){this.value='<?php echo $u_langpackage->fasongneirong;?>';this.style.color='#A9A9A9'}" ><?php echo $u_langpackage->fasongneirong;?></textarea>
	...
	<?php }else{
		...
		echo "<a style='font-size:16px;color:#ff000;' href='modules2.0.php?app=u_horn&active=1'>".$u_langpackage->u_bak."</a>";
	}?>
</div>
