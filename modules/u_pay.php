...
<body id="main_iframe">
	...
	<div id="container_center"  class="box">
					...
					<ul>
						...
						<li class="one"><span><a href="modules2.0.php?app=u_pay"><?php echo $u_langpackage->u_pay;?></a></span></li>

						<li><span><a href="modules2.0.php?app=u_update"><?php echo $u_langpackage->u_update;?></a></span></li>
