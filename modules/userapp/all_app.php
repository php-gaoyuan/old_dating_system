...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
            <li class="active"><a href="modules2.0.php?app=all_app" class="nowbutl"><?php echo $pl_langpackage->pl_app_list;?></a></li>	  	
        </ul>
    </div>
		...
		<ul class="app_list">
			...
			<li onmouseover="this.className += ' list_app_active';" onmouseout="this.className='app_list';">
				<div class="figure_box">
					<a href="modules2.0.php?app=add_app&id=<?php echo $rs["id"];?>"><img src="<?php echo $image_url;?>" title="" alt=""></a>
				</div>
				<h3 class="name">
					<a href="modules2.0.php?app=add_app&id=<?php echo $rs["id"];?>"><?php echo $rs["title"];?></a>
				</h3>
            ...
            <a href="modules2.0.php?app=add_app&id=<?php echo $rs["id"];?>"><?php echo $pl_langpackage->pl_add;?></a>
				</div>
			</li>
			<?php }?>
		</ul>
