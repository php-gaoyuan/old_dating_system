...
<body id="iframecontent">
    <div class="create_button"><a href="modules2.0.php?app=all_app"><?php echo $pl_langpackage->pl_add_app;?></a></div>
    <h2 class="app_set"><?php echo $pl_langpackage->pl_manage;?></h2>
    <div class="tabs">
        <ul class="menu">
            <li class="active"><a href="modules2.0.php?app=mag_app" ><?php echo $pl_langpackage->pl_set_app;?></a></li>	
        </ul>
    </div>
	<?php if($app_rs){?>
		...
		<ul class="app_list">
			...
			<li onmouseover="this.className += ' list_app_active';" onmouseout="this.className='app_list';">
				<div class="figure_box">
					<a href="modules2.0.php?app=add_app&id=<?php echo $rs["id"];?>"><img src="<?php echo $small_url;?>" /></a>
				</div>
				<h3 class="name">
