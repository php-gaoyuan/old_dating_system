...
<h2 class="app_user"><?php echo $u_langpackage->u_set_affair;?></h2>
<div class="tabs">
	<ul class="menu">
        ...
        <li><a href="modules2.0.php?app=user_dressup" title="<?php echo $u_langpackage->u_dressup;?>"><?php echo $u_langpackage->u_dressup;?></a></li>
        <li class="active"><a href="modules2.0.php?app=user_affair" title="<?php echo $u_langpackage->u_set_affair;?>"><?php echo $u_langpackage->u_set_affair;?></a></li>
    </ul>
</div>
