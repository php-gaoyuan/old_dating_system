...
<table class="msg_inbox">
   <?php foreach($hi_rs as $val){?>
    <tr class="loop_tr" id="hi_<?php echo $val['hi_id'];?>">
    	...
    	<td width="30">
		  <div class="avatar"><a href="home2.0.php?h=<?php echo $val['from_user_id'];?>" target="_blank"><img src="<?php echo $val['from_user_ico'];?>"/></a></div>
      </td>
        <td width="70"><img src="skin/<?php echo $skinUrl;?>/images/pokeact_<?php echo $val['hi'];?>.gif"></img></td>
		<td><a href='home2.0.php?h=<?php echo $val['from_user_id'];?>' target='_blank'><?php echo $val['from_user_name'];?></a><?php echo show_hi_type($val['hi']);?></td>
