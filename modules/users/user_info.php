...
<div class="create_button">
	<a target="frame_content" href="modules2.0.php?app=user_info&is_finish=1"><?php echo $u_langpackage->u_perfect_info;?></a>
</div>
<?php }?>
...
<div class="tabs">
	<ul class="menu">
	  <li class="active"><a href="modules2.0.php?app=user_info" title="<?php echo $u_langpackage->u_info;?>"><?php echo $u_langpackage->u_info;?></a></li>
