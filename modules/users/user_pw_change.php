...
<h2 class="app_user"><?php echo $u_langpackage->u_pw;?></h2>
<div class="tabs">
	<ul class="menu">
        <li><a href="modules2.0.php?app=user_info" title="<?php echo $u_langpackage->u_info;?>"><?php echo $u_langpackage->u_info;?></a></li>
        <li><a href="modules2.0.php?app=user_ico" title="<?php echo $u_langpackage->u_icon;?>"><?php echo $u_langpackage->u_icon;?></a></li>
        <li class="active"><a href="modules2.0.php?app=user_pw_change" title="<?php echo $u_langpackage->u_pw;?>"><?php echo $u_langpackage->u_pw;?></a></li>
...
<table border="0" class='form_table'>
  ...
  <tr>
    <td></td>
    <td><input type="submit" name="Submit" class="regular-btn" value="<?php echo $u_langpackage->u_b_con;?>" /><input type="button" name="Submit2" class="regular-btn" onclick="location.href='modules2.0.php?app=user_pw_change'" value="<?php echo $u_langpackage->u_b_can;?>" /></td>
  </tr>
</table>
</form>
</body>
