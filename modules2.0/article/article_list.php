...
<table width="1000" height="44" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<li class="hydqbj"><a style="color:#FFFFFF;" href="modules.php?app=article_list"><?php echo $mp_langpackage->mp_xingzuo;?></a></li>
	</ul>
	</div>
	</td>
...
<?php if($_COOKIE['lp_name']=='en'){?>
	...
	<li>
	<a href='modules.php?app=article_article&id=<?php echo $rs["id"];?>'><img src='<?php echo $rs["thumb"];?>'/></a>
	<h2><?php echo $rs["title"];?></h2>
	<p><?php echo mb_substr(strip_tags($rs["content"]),0,300,'utf-8');?>...</p><p><a href='modules.php?app=article_article&id=<?php echo $rs["id"];?>'>MORE&gt;&gt;</a></p>
	</li>
	<?php }?>
<?php }else{ ?>
	...
	<a href='modules.php?app=article_article&id=<?php echo $rs["id"];?>'><img src='<?php echo $rs["thumb"];?>'/></a>
	<h2><?php echo $rs["title"];?></h2>
	<p><?php echo mb_substr(strip_tags($rs["content"]),0,150,'utf-8');?>...</p><p><a href='modules.php?app=article_article&id=<?php echo $rs["id"];?>'>查看详细&gt;&gt;</a></p>
	</li>
	<?php }?>
<?php }?>
