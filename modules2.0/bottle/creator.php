 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/bottle/creator.html
 * 如果您的模型要进行修改，请修改 models/modules/bottle/creator.php
 *
...
if(filemtime("templates/default/modules/bottle/creator.html") > filemtime(__file__) || (file_exists("models/modules/bottle/creator.php") && filemtime("models/modules/bottle/creator.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/bottle/creator.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
