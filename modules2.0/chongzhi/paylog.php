 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/chongzhi/paylog.html
 * 如果您的模型要进行修改，请修改 models/modules/chongzhi/paylog.php
 *
...
<div class="tabs">
    <ul class="menu">
        ...
        <li class="active"><a href="modules2.0.php?app=user_paylog" hidefocus="true"><?php echo $er_langpackage->er_recharge_log;?></a></li>
