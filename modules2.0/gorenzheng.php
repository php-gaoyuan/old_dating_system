...
function txrz_func(){
	...
	if(!txrz_val || txrz_val==''){top.Dialog.alert('<?php echo $ul->gorz1;?>');return false;}else{
		document.getElementById('txrz_formid').action="modules.php?app=txrz";
	}
}
</script>
<style>
...
<div class="zprz "><a href="main2.0.php?app=renzheng" target="_top"><?php echo $ul->woderenzheng;?><i></i></a></div>
<div class="zprz active2"><a href="main2.0.php?app=gorenzheng" target="_top"><?php echo $ul->zhaopianrenzheng;?><i></i></a></div>
