...
<div class="recom_user" style="margin-bottom:-20px">
   	...
   	<div id="invite">
        ...
        <div class="top"><h2 class="highlight"><?php echo $ah_langpackage->ah_welcome_you;?><a class="highlight"  href="home2.0.php?h=<?php echo $user_info['user_id'];?>" target="_blank"><?php echo $user_info['user_name'];?></a><?php echo $ah_langpackage->ah_invite_you_friends;?></h2></div>
	   	...
	   	<table cellpadding="10" cellspacing="0" class="invite_table">
	   		...
	   		<tr>
	   			...
	   			<td width="28%" valign="top" align="left">
	   				...
	   				<a class="photo_iframe" href="home2.0.php?h=<?php echo $user_info['user_id'];?>">
	   			...
	   			<td width="72%" valign="top">
		   			 ...
		   			 <?php echo $u_langpackage->u_uname;?>：
		   			 	...
		   			 	<a href="home2.0.php?h=<?php echo $user_info['user_id'];?>">
                     ...
                     <p class="mt20"><a href="home2.0.php?h=<?php echo $user_info['user_id'];?>" ><img src="skin/<?php echo $skinUrl;?>/images/tohomelabel.gif" align="middle"></a></p>
