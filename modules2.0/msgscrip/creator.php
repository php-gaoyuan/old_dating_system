...
<body id="iframecontent">
    ...
    <form name="form1" onSubmit="return unitinfocheck();" method="post" action="do2.0.php?act=msg_crt">
          ...
          <tr>
			...
			<td class="<?php echo $id_noconfirm;?>" style="position:relative">
				...
				<div id="sc_nav" onblur="setTimeout('tclose()',200)">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="newsType" onclick="topen();"><?php echo $m_langpackage->m_cho;?> : <?php echo $m_langpackage->m_to_user;?></div>
					<ul class="tt">
