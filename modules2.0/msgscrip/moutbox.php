...
<body id="iframecontent">
    ...
    <div class="tabs" style="margin-top:0">
        <ul class="menu">
            ...
            <li class="active"><a href="modules2.0.php?app=msg_moutbox" title="<?php echo $m_langpackage->m_out;?>" hidefocus="true"><?php echo $m_langpackage->m_out;?></a></li>
...
<form action='do2.0.php?act=msg_del&t=1' method='post' onsubmit='check_form()'>
...
<?php foreach($msg_outbox_rs as $key => $val){?>
	 <tr>
	   <td width="25"><input name="attach[]" type="checkbox" value="<?php echo $val["mess_id"];?>" /></td>
		 <td width="30"><a title='<?php echo $val["mess_title"];?>' href='modules2.0.php?app=msg_rpshow2&id=<?php echo $val["mess_id"];?>&t=1'><img title="<?php echo $val["state"]?$m_langpackage->m_sed:$m_langpackage->m_have_access;?>" src='skin/<?php echo $skinUrl;?>/images/messend_<?php echo $val["state"];?>.gif' /></a></td>
		 ...
		 <td><a title='<?php echo $val["mess_title"];?>' href='modules2.0.php?app=msg_rpshow2&id=<?php echo $val["mess_id"];?>&t=1'><?php echo $val["mess_title"];?></a></td>
		 <td width="20"><a href='do2.0.php?act=msg_del&id=<?php echo $val["mess_id"];?>&t=1' onclick='return confirm("<?php echo $m_langpackage->m_del_ask;?>");'><img title="<?php echo $m_langpackage->m_del;?>" src="skin/<?php echo $skinUrl;?>/images/del.png" /></a></td>
	 </tr>
<?php }?>
</table>
<div class="rs_head <?php echo $show_data;?>">
