...
<body id="iframecontent">
    ...
    <div class="tabs" style="margin-top:0">
        <ul class="menu">
            ...
            <li><a href="modules2.0.php?app=msg_minbox" title="<?php echo $m_langpackage->m_in;?>" hidefocus="true"><?php echo $m_langpackage->m_in;?></a></li>
            ...
            <li class="active"><a href="modules2.0.php?app=msg_notice" title="<?php echo $m_langpackage->m_notice;?>" hidefocus="true"><?php echo $m_langpackage->m_notice;?></a></li>
...
<form action='do2.0.php?act=msg_del&t=2' method='post' onsubmit='check_form()'>
...
<?php foreach($msg_inbox_rs as $key => $val){?>
        <tr>
            ...
            <td width="30"><a title='<?php echo $val["mess_title"];?>' href='modules2.0.php?app=msg_rpshow&id=<?php echo $val["mess_id"];?>&t=2'><img title="<?php echo $val["readed"]?$m_langpackage->m_have_read:$m_langpackage->m_unread;?>" src='skin/<?php echo $skinUrl;?>/images/mesread_<?php echo $val["readed"];?>.gif' /></a></td>
            ...
            <td><a title='<?php echo $val["mess_title"];?>' href='modules2.0.php?app=msg_rpshow&id=<?php echo $val["mess_id"];?>&t=2'><?php echo $val["mess_title"];?></a></td>
            <td width="20"><a href='do2.0.php?act=msg_del&id=<?php echo $val["mess_id"];?>&t=2' onclick='return confirm("<?php echo $m_langpackage->m_del_ask;?>");'><img title="<?php echo $m_langpackage->m_del;?>" src="skin/<?php echo $skinUrl;?>/images/del.png" /></a></td>
		</tr>
<?php }?>
</table>
<div class="rs_head <?php echo $show_data;?>">
