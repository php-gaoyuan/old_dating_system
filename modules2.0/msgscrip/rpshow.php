...
function mypals_add(other_id){
	$.get("do2.0.php?act=add_mypals&other_id="+other_id,function(c){mypals_add_callback(c,other_id);});
}

function join_event(event_id,fellow,template){
	$.post("do2.0.php?act=event_join&event_id="+event_id+"&fellow="+fellow+"template="+template,function(c){parent.Dialog.alert(c);location.href="modules2.0.php?app=event_space&event_id="+event_id});
}
...
<body id="iframecontent">
	...
	<div class="mess_main">
		...
		<div class="mess_xunhuan">
			<div class="mess_xh_tit"><span><a href="do2.0.php?act=msg_del&t=all&hhid=<?php echo $hh_id;?>"><?php echo $m_langpackage->m_qbsc;?></a></span><span><a href="modules2.0.php?app=msg_minbox"><?php echo $m_langpackage->m_fanhuiliebiao;?></a></span></div>
		</div>
		<div class="mess_content">
			...
			<div class="mess_ico" id="mess_c_ico">
				...
				<div class="mess_name <?php if($v['from_user_id']!=$user_id){echo 'self';}else{echo 'other';}?>">
					...
					<a href="do2.0.php?act=msg_del&id=<?php echo $v['mess_id'];?>&t=3&hhid=<?php echo $v['hh_id'];?>"><?php echo $m_langpackage->m_del;?></a></span></p>
				</div>
			</div>
	...
	<div id="huifu"  style="float:left;">
		...
		<form name="form1" onsubmit="sunitinfocheck();" method="post" action="do2.0.php?act=msg_crt_hf" enctype="multipart/form-data">
