        ...
        <div class="pals_list" onmouseover="this.className += ' pals_list_active';" onmouseout="this.className='pals_list';">
            <div class="right">
                ...
                <div class="content_ch1" style="background:url(skin/default/jooyea/images/ch.jpg) ">
                    ...
                    <a style="width:22px;height:22px;float:left;display:block" href="javascript:;" title="<?php echo $rf_langpackage->rf_fayoujian;?>" onclick="top.frame_content.location.href='modules.php?app=msg_creator&2id=<?php echo $rs[user_id];?>';return false;"></a>
            ...
            <div class="avatar">
                <a href="home2.0.php?h=<?php echo $rs['user_id'];?>" target="_blank">
                    <img alt="<?php echo $mp_langpackage->mp_en_home;?>" title='<?php echo $mp_langpackage->mp_sex;?>:<?php echo get_pals_sex($rs['user_sex ']);?>' src='<?php echo $rs["user_ico"];?>' />
                </a>
            </div>
            <dl>
                <dd>
