    ...
    <?php if($ses_uid&&$poll_row['user_id']!=$ses_uid){?>
		...
		<div class="poll_initiator <?php echo $sendor_info;?>">
			...
			<div class="poll_userinfo">
				...
				<p><a class="first" href='home2.0.php?h=<?php echo $poll_row['user_id'];?>' target='_blank'><?php echo str_replace("{name}",filt_word($poll_row['username']),$pol_langpackage->pol_who_home);?></a><a href="modules.php?app=poll_list&user_id=<?php echo $poll_row['user_id'];?>">TA<?php echo $pol_langpackage->pol_vote;?></a><a href='javascript:window.history.go(-1);'><?php echo $pol_langpackage->pol_re_last;?></a></p>
			</div>
		</div>
		<div class="clear"></div>
