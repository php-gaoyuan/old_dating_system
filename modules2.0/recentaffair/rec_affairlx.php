 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/recentaffair/rec_affairlx.html
 * 如果您的模型要进行修改，请修改 models/modules/recentaffair/rec_affairlx.php
 *
...
if(filemtime("templates/default/modules/recentaffair/rec_affairlx.html") > filemtime(__file__) || (file_exists("models/modules/recentaffair/rec_affairlx.php") && filemtime("models/modules/recentaffair/rec_affairlx.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/recentaffair/rec_affairlx.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<li id="feed_2" style="padding-left:97px;padding-right:15px;">
  ...
  <div class="details">
	...
	<span class="app_group" style="cursor: pointer;background: url('/skin/<?php echo $skinUrl;?>/images/appbg.gif') no-repeat scroll 0 -202px transparent;float:right;width:25px;height:15px;" onclick="location='/modules.php?app=msg_creator&2id=<?php echo $rs["user_id"];?>&nw=2';">&nbsp;</span>
	</div>
