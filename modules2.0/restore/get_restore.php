...
<?php foreach($com_rs as $rs){?>
 ...
 <!------------------------循环项----------------------->
            ...
            <dt>
            <a target="_blank" class="name_box1_lf" href="home2.0.php?h=<?php echo $rs["visitor_id"];?>"><img src="<?php echo $rs["visitor_ico"];?>" width="38" height="38" alt="<?php echo filt_word($rs["visitor_name"]);?>"></a>
            </dt>
            <dd>
            <p><a class="name_box1_lq"><?php echo filt_word($rs["visitor_name"]);?></a></p> 
            <div class="somethingnew_tr"><?php echo filt_word(get_face($rs["content"]));?></div>
            <p class="info_box1_lf">
            <span class="send_time" dateutc="<?php echo $rs["add_time"];?>"><?php echo $rs["add_time"];?></span>
            <span class="comment_op1_lq"><a class="translate_op1_lq trans" ><?php echo $rl->rf_fanyi;?></a></span>
            </p>
            </dd>
	...
	<?php foreach($com_rs as $rs){?>
		<div class="reaction" id="record_<?php echo $type_id;?>_<?php echo $rs["comment_id"];?>">
			...
			<?php }?>
			<a href="home2.0.php?h=<?php echo $rs["visitor_id"];?>" target="_blank" class="figure"><img src="<?php echo $rs["visitor_ico"];?>" /></a>
			<a href="home2.0.php?h=<?php echo $rs["visitor_id"];?>" target="_blank"><?php echo filt_word($rs["visitor_name"]);?></a><label><?php echo $rs["add_time"];?>
			...
			<p class="left"><span id="sub_com_<?php echo $rs['comment_id'];?>"><?php echo filt_word(get_face($rs["content"]));?></span> <a href="javascript:;" onclick="if(document.getElementById('com_list_<?php echo $rs['comment_id'];?>').style.display=='none'){document.getElementById('com_list_<?php echo $rs['comment_id'];?>').style.display=''}else{document.getElementById('com_list_<?php echo $rs['comment_id'];?>').style.display='none'}">[<?php echo $rl->rf_fanyi;?>]</a>
			<span class="f_list" id="com_list_<?php echo $rs['comment_id'];?>" style="display:none">
				<span>
				<a href='javascript:fyc_com(<?php echo $rs['comment_id'];?>,"en","<?php echo $rs['visitor_id'];?>");'>English</a>
				<a href='javascript:fyc_com(<?php echo $rs['comment_id'];?>,"zh","<?php echo $rs['visitor_id'];?>");'>中文</a>
				<a href='javascript:fyc_com(<?php echo $rs['comment_id'];?>,"kor","<?php echo $rs['visitor_id'];?>");'>한국어</a>
				<a href='javascript:fyc_com(<?php echo $rs['comment_id'];?>,"ru","<?php echo $rs['visitor_id'];?>");'>русский</a>
				<a href='javascript:fyc_com(<?php echo $rs['comment_id'];?>,"spa","<?php echo $rs['visitor_id'];?>");'>Español</a>
				<a href='javascript:fyc_com(<?php echo $rs['comment_id'];?>,"fra","<?php echo $rs['visitor_id'];?>");'>Français</a>
				<a href='javascript:fyc_com(<?php echo $rs['comment_id'];?>,"jp","<?php echo $rs['visitor_id'];?>");'>日本語</a></span>
			</span></p>
		</div>
