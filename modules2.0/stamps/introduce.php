 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/stamps/introduce.html
 * 如果您的模型要进行修改，请修改 models/modules/stamps/introduce.php
 *
...
if(filemtime("templates/default/modules/stamps/introduce.html") > filemtime(__file__) || (file_exists("models/modules/stamps/introduce.php") && filemtime("models/modules/stamps/introduce.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/stamps/introduce.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
