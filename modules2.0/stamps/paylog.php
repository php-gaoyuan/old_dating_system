 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/stamps/paylog.html
 * 如果您的模型要进行修改，请修改 models/modules/stamps/paylog.php
 *
...
if(filemtime("templates/default/modules/stamps/paylog.html") > filemtime(__file__) || (file_exists("models/modules/stamps/paylog.php") && filemtime("models/modules/stamps/paylog.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/stamps/paylog.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<div class="tabs">
    <ul class="menu">
        ...
        <li class="active"><a href="modules.php?app=user_paylog" hidefocus="true"><?php echo $er_langpackage->er_recharge_log;?></a></li>
