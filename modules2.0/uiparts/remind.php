...

{
...

	{
		...
		$mess=str_replace("Gifts","个礼物",$mess);

		$mess=str_replace("Guest","位访客",$mess);
...

{
...

	{
		...
		$mess=str_replace("个礼物","Gifts",$mess);

		$mess=str_replace("位访客","Guest",$mess);
...
<div class="sideitem <?php echo $isset_data;?>" style="background-color:#fff;margin-top:0;">
    ...
    <div class="container" style="margin:4px; height:50px; overflow:hidden">
        ...
        <div class="sideitem_body">
                ...
                <div class="remind_<?php echo $rs['type_id'];?>"><a target="_blank" href="<?php echo $rs['link'];?>" target='frame_content' onclick='clear_remind(<?php echo $rs['id'];?>);'><?php echo str_replace("{num}",$rs['count'],$rs['content']);?></a></div>
