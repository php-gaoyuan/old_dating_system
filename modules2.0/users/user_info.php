...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <script src="servtools/area.js" type="text/javascript">
        </script>
        <SCRIPT language=JavaScript src="servtools/ajax_client/ajax.js">
        </SCRIPT>
    </head>
    ...
    <body id="iframecontent">
        <?php if($url_uid==$ses_uid){?>
            <div class="create_button">
                <a target="frame_content" href="modules.php?app=user_info&is_finish=1">
                    <?php echo $u_langpackage->u_perfect_info;?>
                </a>
            </div>
            <?php }?>
                <h2 class="app_user">
                    <?php echo $u_langpackage->u_info;?>
                </h2>
                <?php if(!$show_type){?>
                    <?php if(!$is_finish){?>
                        <div class="tabs">
                            <ul class="menu">
                                <li class="active">
                                    <a href="modules.php?app=user_info" title="<?php echo $u_langpackage->u_info;?>">
                                        <?php echo $u_langpackage->u_info;?>
                                    </a>
                                </li>
                                <li>
                                    <a href="modules.php?app=user_ico" title="<?php echo $u_langpackage->u_icon;?>">
                                        <?php echo $u_langpackage->u_icon;?>
                                    </a>
                                </li>
                                <li>
                                    <a href="modules.php?app=user_pw_change" title="<?php echo $u_langpackage->u_pw;?>">
                                        <?php echo $u_langpackage->u_pw;?>
                                    </a>
                                </li>
                                <li>
                                    <a href="modules.php?app=user_affair" title="<?php echo $u_langpackage->u_set_affair;?>">
                                        <?php echo $u_langpackage->u_set_affair;?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <div class="rs_head">
                            <?php echo $u_langpackage->u_fill;?>
                        </div>
                        <?php }?>
                            <form name="form" method="post" action="do.php?act=user_info&is_finish=<?php echo $is_finish;?>"
                            onsubmit="return check_form();">
                                <table class="form_table" border="0" style="display:block;border:1px solid #ccc;border-radius:6px;width;460px;padding:10px 0">
                                    ...
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->u_res;?>
                                        </th>
                                        <td>
                                            <div>
                                                <select onchange="document.getElementById('cou').value=this.value">
                                                    <?php if($user_row[ 'country']){?>
                                                        <option value="<?php echo $user_row['country'];?>" checked>
                                                            <?php echo $user_row[ "country"];?>
                                                        </option>
                                                        <?php }?>
                                                            <option value="">
                                                                -
                                                                <?php echo $u_langpackage->u_select;?>-
                                                            </option>
                                                            <?php foreach($county as $c){ ?>
                                                                <option value="<?php echo $c['cname']; ?>">
                                                                    <?php echo $c[ 'cname'];?>
                                                                </option>
                                                                <?php }?>
                                                </select>
                                    ...
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->waimao;?>
                                        </th>
                                        <td>
                                            <label>
                                                <input type="radio" name="waimao" value="1" <?php if($uinfo[ 'waimao']==1)
                                                echo 'checked';?>
                                                />
                                                <?php echo $u_langpackage->yiban;?>&nbsp;
                                            </label>
                                            <label>
                                                <input type="radio" name="waimao" value="2" <?php if($uinfo[ 'waimao']==2)
                                                echo 'checked';?>
                                                />
                                                <?php echo $u_langpackage->haokan;?>&nbsp;
                                            </label>
                                            <label>
                                                <input type="radio" name="waimao" value="3" <?php if($uinfo[ 'waimao']==3)
                                                echo 'checked';?>
                                                />
                                                <?php echo $u_langpackage->chuzhong;?> &nbsp;
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->xingquxiang;?>
                                        </th>
                                        <td>
                                            <label>
                                                <input type="radio" name="sexual" value="1" <?php if($uinfo[ 'sexual']==1)
                                                echo 'checked';?>
                                                />
                                                <?php echo $u_langpackage->yixing;?>&nbsp;
                                            </label>
                                            <label>
                                                <input type="radio" name="sexual" value="2" <?php if($uinfo[ 'sexual']==2)
                                                echo 'checked';?>
                                                />
                                                <?php echo $u_langpackage->tongxing;?>&nbsp;
                                            </label>
                                            <label>
                                                <input type="radio" name="sexual" value="3" <?php if($uinfo[ 'sexual']==3)
                                                echo 'checked';?>
                                                />
                                                <?php echo $u_langpackage->shuangxing;?>&nbsp;
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->shengao;?>
                                        </th>
                                        <td>
                                            <select name="height" id="height">
                                                <?php if($uinfo[ 'height']){?>
                                                    <option value="<?php echo $uinfo['height'];?>">
                                                        <?php echo $uinfo[ 'height'];?>
                                                    </option>
                                                    <?php }?>
                                                        <option value="">
                                                            <?php echo $u_langpackage->u_select;?>
                                    ...
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->tizhong;?>
                                        </th>
                                        <td>
                                            <input type="text" class="small-text" name="weight" id="weight" value="<?php echo $uinfo['weight'];?>"
                                            />
                                            kg
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->shouru;?>
                                        </th>
                                        <td>
                                            <select name="income" id="income">
                                                <?php if($uinfo[ 'income']){?>
                                                    <option value="<?php echo $uinfo['income'];?>">
                                                        <?php echo $uinfo[ 'income'];?>
                                                    </option>
                                                    <?php }?>
                                                        <option value="">
                                                            <?php echo $u_langpackage->u_select;?>
                                    ...
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->u_outline;?>
                                        </th>
                                        <td>
                                            <textarea id="msContent" maxlength="150" name="gerenjieshao">
                                                <?php echo $user_row[ 'gerenjieshao'];?>
                                            </textarea>
                                        </td>
                                    </tr>
                                    <SCRIPT language=JavaScript src="servtools/kindeditor/kindeditor.js">
                                    </SCRIPT>
                                    <script>
                                        var editor;
                                    ...
                                    <tr>
                                        <th>
                                            <?php echo $u_langpackage->u_reg_time;?>
                                        </th>
                                        <td>
                                            <?php echo $user_row[ 'user_add_time'];?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="submit" name="profilesubmit2" value="<?php echo $u_langpackage->u_b_con;?>"
                                            class="regular-btn" />
                                ...
                                <?php if($show_type){?>
                                    <table class="form_table" style="display:block;border:1px solid #ccc;border-radius:6px;width;460px;padding:10px 0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $user_row[ "birth_year"]&&$user_row[ "birth_month"]&&$user_row[
                                                "birth_day"]?$user_row[ "birth_year"].$u_langpackage->u_year.$user_row["birth_month"].$u_langpackage->u_month.$user_row["birth_day"].$u_langpackage->u_day:$u_langpackage->u_set;?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <?php echo $user_row[ 'country']?$user_row[ 'country']:$u_langpackage->u_set;?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <?php if($user_row[ 'waimao']==1){echo $u_langpackage->yiban;}elseif($user_row['waimao']==2){echo $u_langpackage->haokan;}elseif($user_row['waimao']==3){echo $u_langpackage->chuzhong;}else{echo $u_langpackage->u_set;}?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <?php if($user_row[ 'sexual']==1){echo $u_langpackage->yixing;}elseif($user_row['sexual']==2){echo $u_langpackage->tongxing;}elseif($user_row['sexual']==3){echo $u_langpackage->shuangxing;}else{echo $u_langpackage->u_set;}?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <?php echo $user_row[ 'height']?$user_row[ 'height']:$u_langpackage->u_set;?>cm
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <?php echo $user_row[ 'weight']?$user_row[ 'weight']:$u_langpackage->u_set;?>kg
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <?php echo $user_row[ 'income']?$user_row[ 'income']:$u_langpackage->u_set;?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <div style="width:300px;border:1px solid #D3D3D3;border-radius:5px;padding:10px;min-height:100px;">
                                                    <?php if($user_row[ 'gerenjieshao']){echo $user_row[ 'gerenjieshao'];}else{echo
                                                    $u_langpackage->u_set;}?>
                                                </div>
                                            </td>
                                        </tr>
