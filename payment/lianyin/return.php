...
//file_put_contents("lianyin_pc_return22.log", date("Y-m-d H:i:s").PHP_EOL.var_export($_REQUEST, 1) .PHP_EOL, FILE_APPEND);
$dbo = new dbex;
dbtarget('w',$dbServs);
...
$dbo->exeUpdate($sql);
file_put_contents("lianyin_pc_return2".date("m-d").".log", date("Y-m-d H:i:s").PHP_EOL.var_export($_GET, 1) .PHP_EOL, FILE_APPEND);
