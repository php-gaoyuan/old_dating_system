...
class Paypal{
    ...
    */
    function GetCode($order){
		...
		$mess.='<input type="hidden" name="cancel_return" value="http://'.$_SERVER['HTTP_HOST'].'">';
		...
		$mess.='</form><script>document.paypal.submit();</script></body>';
        return $mess;
    }
