...
#gift_list{ float:left; border:#C2D9F2 solid 1px;margin-bottom:10px;padding:5px;width:640px;}
#gift_friends{
	clear:both;
...
#gift_list .giftbox{
	width:150px;float:left;text-align:center;font-size:12px;margin-left:7px;
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="color:#333333;">
  <tr>
	...
	<td><input id="accept" name="accept" style="border:1px #ccc solid;width:80px;" value="<?php echo $user_name;?>" onchange="checkname(value)"/>
	<span>
  ...
  <tr height="100%">
	...
	<td>
		<ul id="zishu">
		  <li class="nav_a active"><a href="javascript:;" onclick="getGifts(1);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_putong;?></span></a></li>
		  <li class="nav_a"><a href="javascript:;" onclick="getGifts(2);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_gaoji;?></span></a></li>
		  <li class="nav_a"><a href="javascript:;" onclick="getGifts(3);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_chaoji;?></span></a></li>
