...
if(get_sess_userid())
{
	...
	{
		echo "<div class='giftbox'><label><img title='".$gift['giftname']."' width=150 height=150 src='/".$gift['patch']."'/><span><img src='/skin/default/jooyea/images/s_main_46.gif' style='vertical-align:middle;'/>&nbsp;".$gift['money']."</span><input type='radio' name='gift_img' checked value='".$gift['id']."'/></label></div>";
	}
	if($totalpage>1)
	{
