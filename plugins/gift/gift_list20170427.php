...
if(get_sess_userid())
{
	...
	{
		echo "<div class='giftbox'><label><img title='".$gift['giftname']."' width=70 height=70 src='/".$gift['patch']."'/><span style="font-size: 20px"><img src='/skin/default/jooyea/images/s_main_46.gif' style='vertical-align:middle;'/>&nbsp;".$gift['money']."</span><input type='radio' name='gift_img' checked value='".$gift['id']."'/></label></div>";
	}
	if($totalpage>1)
	{
