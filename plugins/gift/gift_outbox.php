...
#gift_list{ float:left; border:#C2D9F2 solid 1px;margin-bottom:10px;padding:5px;width:780px;}
#gift_friends{
	clear:both;
...
</script><style>li#active{background:#fff;}li#active a{color:#A33F3F}</style>
</head>
...
<div class="tabs">
    ...
    <li><a href="javascript:;" onclick="getGifts(4);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_zhenshi;?></span></a></li>
        ...
        <li><a href="javascript:;" onclick="getGifts(3);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_nvshi;?></span></a></li>
		  ...
		  <li><a href="javascript:;" onclick="getGifts(6);changeStyle_gift(this);"><?php echo $gf_langpackage->gf_changjianwenti;?></a></li>
