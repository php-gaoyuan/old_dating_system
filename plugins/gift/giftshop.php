  ...
  <tr height="100%">
	...
	<td>
		...
		<ul id="zishu">
		  ...
		  <li class="nav_a active"><a href="javascript:;" onclick="getGifts(4);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_zhenshi;?></span></a></li>

		  <li class="nav_a"><a href="javascript:;" onclick="getGifts(2);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_nanshi;?></span></a></li>

		  <li class="nav_a"><a href="javascript:;" onclick="getGifts(3);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_nvshi;?></span></a></li>

		  

		  <li class="nav_a"><a href="javascript:;" onclick="getGifts(5);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_liwuwenhua;?></span></a></li>

		  <li class="nav_a"><a href="javascript:;" onclick="getGifts(6);changeStyle_gift(this);"><span><?php echo $gf_langpackage->gf_changjianwenti;?></span></a></li>

		  <li class="nav_a"><a href="javascript:;" onclick="location.href='<?php echo $siteDomain;?>plugins/gift/gift_box.php';return false;"><span><?php echo $gf_langpackage->gf_putin;?></span></a></li>

		  <li class="nav_a"><a href="javascript:;" onclick="location.href='<?php echo $siteDomain;?>plugins/gift/gift_outbox.php';return false;"><span><?php echo $gf_langpackage->gf_putout;?></span></a></li>
		...
		<div id="gift_list" style="width:780px;"></div>
