		...
		<div class="mainbg" id="step2">
			<div class="mainbgs">
				...
				<div class="mainbg_con">
					...
					<div class="mainbg_gift">
						<a href="/main.php?v=<?php echo $gift2['id']; ?>" target="_blank" title="<?php echo $gift2['giftname']; ?>"><img alt="<?php echo $gift2['giftname']; ?>" src="<?php echo '/'.$gift2['yuanpatch']; ?>" />
		...
		<div class="mainbg" id="step3">
			<div class="mainbgs">
				...
				<div class="mainbg_con">
					...
					<div class="mainbg_gift">
						<a href="/main.php?v=<?php echo $gift3['id']; ?>" target="_blank" title="<?php echo $gift3['giftname']; ?>"><img alt="<?php echo $gift3['giftname']; ?>" src="<?php echo '/'.$gift3['yuanpatch']; ?>" />
		...
		<div class="mainbg" id="step4">
			<div class="mainbgs">
				...
				<div class="mainbg_con">
					...
					<div class="mainbg_gift">
						<a href="/main.php?v=<?php echo $gift4['id']; ?>" target="_blank" title="<?php echo $gift4['giftname']; ?>"><img alt="<?php echo $gift4['giftname']; ?>" src="<?php echo '/'.$gift4['yuanpatch']; ?>" />
