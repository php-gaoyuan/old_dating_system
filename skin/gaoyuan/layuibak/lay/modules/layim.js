...
function(i) {
    ...
    $ = function(i) {
        j.mine.id = j.mine.id ? j.mine.id : chat.userinfo.user_id;
        var a = layui.data("layim")[j.mine.id] || {},
        e = {},
        t = a.history || {},
        l = t[i.type + i.id];
    ...
    P = function(i) {
        ...
        function(n, l) {
            ...
            a ? ""
            /*t.msg("好友 ["+(i.username||"")+"] 已经存在列表中",{anim:6})*/
