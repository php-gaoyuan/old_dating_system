...
(function($){
    $.fn.commentTree=function(setting,arg){
        ...
        if(typeof setting=='string')return runDatafun(setting,this,arg);
        var options={
            html:{templateParent:'<dl datalq1="Id:${id},userId:${userId}"><dt><img src="${userIdImg}" width="32" height="32" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}：&nbsp;</a>${content}</p><p><span class="send_time" dateutc="${sendTime}"></span><span class="comment_op1_lq"><a class="recomment_op1_lq">${recommentText}</a><a class="delete_op1_lq close_icon1_lq">×</a></span></p></dd>',
                templateChild:'<dd><dl datalq1="Id:${id},userId:${userId}" class="child_box1_lq"><dt><img src="${userIdImg}" width="32" height="32" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;${recommentText}&nbsp;${parentUserId}：</a>${content}</p><p><span class="send_time" dateutc="${sendTime}"></span><span class="comment_op1_lq"><a class="recomment_op1_lq">${recommentText}</a><a class="delete_op1_lq close_icon1_lq">×</a></span></p></dd></dl></dd>',
    ...
    function Reply(root, setting) {
        this.options = {
            ...
            tree: {
                ...
                delNode: $.noop,
                template: {
                    inner: '<dd><dl datalq1="Id:${id},userId:${userId}" class="child_box1_lq"><dt><img src="${userIdImg}" width="32" height="32" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;${recommentText}&nbsp;${parentUserId}：</a>${content}</p><p><span class="send_time" dateutc="${sendTime}"></span><span class="comment_op1_lq"><a class="recomment_op1_lq">${recommentText}</a><a class="delete_op1_lq close_icon1_lq">×</a></span></p></dd></dl></dd>',
                    outer: '<dl datalq1="Id:${id},userId:${userId}"><dt><img src="${userIdImg}" width="32" height="32" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;：</a>${content}</p><p><span class="send_time" dateutc="${sendTime}"></span><span class="comment_op1_lq"><a class="recomment_op1_lq">${recommentText}</a><a class="delete_op1_lq close_icon1_lq">×</a></span></p></dd></dl>',
                    data: {}
                }
            }
        };
