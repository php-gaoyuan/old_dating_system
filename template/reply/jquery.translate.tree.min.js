...
(function ($) {
    $.comment_tree = function (setting) {
        ...
        tt = $('#CommentTree .comment_tree1_lq').commentTree({//心情详情页
            html: { templateParent: '<dl datalq1="Id:${id},userId:${userId}" class="comment_box_lf"><dt><img src="${memberHeader}" alt="${userId}"/></dt><dd><p style="position:relative;">${deleteHtml}<a class="name_box1_lq">${userId}：&nbsp;</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="comment_trans" id="trans_${id}">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a><a class="report_comment defHide" receiver="${userId}">${report_commentText}</a></p></dd>',
                templateChild: '<dd><dl datalq1="Id:${id},userId:${userId}" class="child_box1_lq"><dt><img src="${memberHeader}" alt="${userId}"/></dt><dd><p style="position:relative;">${deleteHtml}<a class="name_box1_lq">${userId}&nbsp;${recommentText}&nbsp;${parentUserId}：</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="comment_trans" id="trans_${id}">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a><a class="report_comment" receiver="${userId}">${report_commentText}</a></p></dd></dl></dd>',
         ...
         tt = $('#CommentTree .comment_tree1_lq').commentTree({//日志相册
             html: { templateParent: '<dl datalq1="Id:${id},userId:${userId}" class="comment_box_lf"><dt><img src="${memberHeader}" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}：&nbsp;</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="report_comment" receiver="${userId}">${report_commentText}</a><a class="comment_trans" id="trans_${id}">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a>${deleteHtml}</p></dd>',
                 templateChild: '<dd><dl datalq1="Id:${id},userId:${userId}" class="child_box1_lq"><dt><img src="${memberHeader}" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;${recommentText}&nbsp;${parentUserId}：</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="report_comment" receiver="${userId}">${report_commentText}</a><a class="comment_trans" id="trans_${id}">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a>${deleteHtml}</p></dd></dl></dd>',
                 templateClose: '<dd class="hidden1_lq reply_box1_lq"></dd></dl>',
                 staticData: { translateText: options.btnTranslate,
                     recommentText: options.btnReply,
                     report_commentText: options.btnReport,
        ...
        $('#CommentTree').reply({
            tree: {
                ...
                delNode: delComment,
                template: {
                    inner: '<dd><dl datalq1="Id:${id},userId:${userId}" class="child_box1_lq"><dt><img src="${memberHeader}" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;${recommentText}&nbsp;${parentUserId}：</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="report_comment" receiver="${userId}">${report_commentText}</a><a class="comment_trans" id="trans_${id}">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a>${deleteHtml}</p></dd></dl></dd>',
        ...
        $(".js_select_top label").bind("click", function (e) {            
            if (($("#iframe_div_lf").height() ? $("#iframe_div_lf").height() < 720 : false) || ($("#iframe_div_lq").height() ? $("#iframe_div_lq").height() < 720 : false)) {
                $(this).closest(".js_select_top").find("ul").css({ "left": "10px", "top": "-25px" });
            } else {
                $(this).closest(".js_select_top").find("ul").css({ "left": "auto", "top": "auto" });
            }
        ...
        function submitReply() {
            ...
            if ($(".mood-treeDetail").length > 0) {//mood
                reply.submitReply(this, null, {
                    inner: '<dd><dl datalq1="Id:${id},userId:${userId}" class="child_box1_lq"><dt><img src="${memberHeader}" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;${recommentText}&nbsp;${parentUserId}：</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="report_comment" receiver="${userId}">${report_commentText}</a><a class="comment_trans" id="trans_id">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a>${deleteHtml}</p></dd></dl></dd>',
                    outer: '<dl class="comment_box_lf" datalq1="Id:${id},userId:${userId}"><dt><img src="${memberHeader}" width="32" height="32" alt="${userId}"/></dt><dd><p style="position:relative;">${deleteHtml}<a class="name_box1_lq">${userId}&nbsp;：</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="comment_trans" id="trans_id">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a><a class="report_comment" receiver="${userId}">${report_commentText}</a>${deleteHtml}</p></dd><dd class="hidden1_lq reply_box1_lq"></dd></dl>'
                });
            } else {
                reply.submitReply(this, null, {//daily and photo
                    inner: '<dd><dl datalq1="Id:${id},userId:${userId}" class="child_box1_lq"><dt><img src="${memberHeader}" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;${recommentText}&nbsp;${parentUserId}：</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="report_comment" receiver="${userId}">${report_commentText}</a><a class="comment_trans" id="trans_id">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a>${deleteHtml}</p></dd></dl></dd>',
                    outer: '<dl class="comment_box_lf" datalq1="Id:${id},userId:${userId}"><dt><img src="${memberHeader}" width="32" height="32" alt="${userId}"/></dt><dd><p><a class="name_box1_lq">${userId}&nbsp;：</a><span class="comment_content">${content}</span></p><p><span class="send_time" dateutc="${date}">${UTCDate}</span><a class="report_comment" receiver="${userId}">${report_commentText}</a><a class="comment_trans" id="trans_id">${comment_transText}</a><a class="recomment_op1_lq">${recommentText}</a>${deleteHtml}</p></dd><dd class="hidden1_lq reply_box1_lq"></dd></dl>'
                });
            }
